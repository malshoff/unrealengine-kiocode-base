...
class ABP_BRT_Bomb_C final : public AActor
{
public:
	...
	uint8                                         Pad_110A[0x6];                                     // 0x025A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_110B[0x3];                                     // 0x0285(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ExecuteUbergraph_BP_BRT_Bomb(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"BP_BRT_Bomb_C">();
	}
	static class ABP_BRT_Bomb_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_BRT_Bomb_C>();
	}
};
static_assert(alignof(ABP_BRT_Bomb_C) == 0x000008, "Wrong alignment on ABP_BRT_Bomb_C");
static_assert(sizeof(ABP_BRT_Bomb_C) == 0x000290, "Wrong size on ABP_BRT_Bomb_C");
static_assert(offsetof(ABP_BRT_Bomb_C, UberGraphFrame) == 0x000220, "Member 'ABP_BRT_Bomb_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, PointLight) == 0x000228, "Member 'ABP_BRT_Bomb_C::PointLight' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Explosion) == 0x000230, "Member 'ABP_BRT_Bomb_C::Explosion' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Area_Trigger) == 0x000238, "Member 'ABP_BRT_Bomb_C::Area_Trigger' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Damage) == 0x000240, "Member 'ABP_BRT_Bomb_C::Damage' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Sphere) == 0x000248, "Member 'ABP_BRT_Bomb_C::Sphere' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, DefaultSceneRoot) == 0x000250, "Member 'ABP_BRT_Bomb_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Triggered) == 0x000258, "Member 'ABP_BRT_Bomb_C::Triggered' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Exploded) == 0x000259, "Member 'ABP_BRT_Bomb_C::Exploded' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionSound) == 0x000260, "Member 'ABP_BRT_Bomb_C::ExplosionSound' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionParticles) == 0x000268, "Member 'ABP_BRT_Bomb_C::ExplosionParticles' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionMixModifier) == 0x000270, "Member 'ABP_BRT_Bomb_C::ExplosionMixModifier' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionDuckMinDistance) == 0x000278, "Member 'ABP_BRT_Bomb_C::ExplosionDuckMinDistance' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionDuckMaxDistance) == 0x00027C, "Member 'ABP_BRT_Bomb_C::ExplosionDuckMaxDistance' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ExplosionDuckingTime) == 0x000280, "Member 'ABP_BRT_Bomb_C::ExplosionDuckingTime' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, Ready) == 0x000284, "Member 'ABP_BRT_Bomb_C::Ready' has a wrong offset!");
static_assert(offsetof(ABP_BRT_Bomb_C, ArmingDelay) == 0x000288, "Member 'ABP_BRT_Bomb_C::ArmingDelay' has a wrong offset!");
