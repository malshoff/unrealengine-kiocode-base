...
// Parameters:
// struct FKey                             InDefaultKey                                           (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// struct FKey                             InConsoleOverride                                      (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)

void UBasic_ToolTip_C::SetInput(const struct FKey& InDefaultKey, const struct FKey& InConsoleOverride)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Basic_ToolTip_C", "SetInput");

	Params::Basic_ToolTip_C_SetInput Parms{};

	Parms.InDefaultKey = std::move(InDefaultKey);
	Parms.InConsoleOverride = std::move(InConsoleOverride);
