...
#include "Magma_MapWidget_classes.hpp"
#include "Magma_MapWidget_parameters.hpp"
...
void UMagma_MapWidget_C::GetBasePanel(class UCanvasPanel** Panel)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("Magma_MapWidget_C", "GetBasePanel");

	Params::Magma_MapWidget_C_GetBasePanel Parms{};
