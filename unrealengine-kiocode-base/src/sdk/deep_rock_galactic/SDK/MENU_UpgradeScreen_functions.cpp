...
// Function MENU_UpgradeScreen.MENU_UpgradeScreen_C.Toggle Sidebar Collapsed
// (BlueprintCallable, BlueprintEvent)

void UMENU_UpgradeScreen_C::Toggle_Sidebar_Collapsed()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MENU_UpgradeScreen_C", "Toggle Sidebar Collapsed");

	UObject::ProcessEvent(Func, nullptr);
}


// Function MENU_UpgradeScreen.MENU_UpgradeScreen_C.ResetSideBar
// (BlueprintCallable, BlueprintEvent)

void UMENU_UpgradeScreen_C::ResetSideBar()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MENU_UpgradeScreen_C", "ResetSideBar");

	UObject::ProcessEvent(Func, nullptr);
}


// Function MENU_UpgradeScreen.MENU_UpgradeScreen_C.BndEvt__MENU_UpgradeScreen_ITM_UpgGear_Upgrades_K2Node_ComponentBoundEvent_9_OnToggleCollapsed__DelegateSignature
// (BlueprintEvent)

void UMENU_UpgradeScreen_C::BndEvt__MENU_UpgradeScreen_ITM_UpgGear_Upgrades_K2Node_ComponentBoundEvent_9_OnToggleCollapsed__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MENU_UpgradeScreen_C", "BndEvt__MENU_UpgradeScreen_ITM_UpgGear_Upgrades_K2Node_ComponentBoundEvent_9_OnToggleCollapsed__DelegateSignature");
...
struct FEventReply UMENU_UpgradeScreen_C::OnKeyUp(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MENU_UpgradeScreen_C", "OnKeyUp");

	Params::MENU_UpgradeScreen_C_OnKeyUp Parms{};
