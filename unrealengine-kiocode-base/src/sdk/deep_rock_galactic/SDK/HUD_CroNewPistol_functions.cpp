...
#include "HUD_CroNewPistol_classes.hpp"
#include "HUD_CroNewPistol_parameters.hpp"
...
void UHUD_CroNewPistol_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "Construct");
...
void UHUD_CroNewPistol_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "SetData");

	Params::HUD_CroNewPistol_C_SetData Parms{};
...
void UHUD_CroNewPistol_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "OnSpreadChanged");

	Params::HUD_CroNewPistol_C_OnSpreadChanged Parms{};
...
void UHUD_CroNewPistol_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "PreConstruct");

	Params::HUD_CroNewPistol_C_PreConstruct Parms{};
...
void UHUD_CroNewPistol_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "OnDamagedEnemy_Event");

	Params::HUD_CroNewPistol_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CroNewPistol_C::ExecuteUbergraph_HUD_CroNewPistol(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewPistol_C", "ExecuteUbergraph_HUD_CroNewPistol");

	Params::HUD_CroNewPistol_C_ExecuteUbergraph_HUD_CroNewPistol Parms{};
