...
#include "HUD_CroNewAssaultRifle_classes.hpp"
#include "HUD_CroNewAssaultRifle_parameters.hpp"
...
void UHUD_CroNewAssaultRifle_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "Construct");
...
void UHUD_CroNewAssaultRifle_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "SetData");

	Params::HUD_CroNewAssaultRifle_C_SetData Parms{};
...
void UHUD_CroNewAssaultRifle_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "OnSpreadChanged");

	Params::HUD_CroNewAssaultRifle_C_OnSpreadChanged Parms{};
...
void UHUD_CroNewAssaultRifle_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "PreConstruct");

	Params::HUD_CroNewAssaultRifle_C_PreConstruct Parms{};
...
void UHUD_CroNewAssaultRifle_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "OnDamagedEnemy_Event");

	Params::HUD_CroNewAssaultRifle_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CroNewAssaultRifle_C::ExecuteUbergraph_HUD_CroNewAssaultRifle(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewAssaultRifle_C", "ExecuteUbergraph_HUD_CroNewAssaultRifle");

	Params::HUD_CroNewAssaultRifle_C_ExecuteUbergraph_HUD_CroNewAssaultRifle Parms{};
