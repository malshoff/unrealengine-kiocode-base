...
public:
	...
	uint8                                         Pad_3110[0x5];                                     // 0x035B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(USCREEN_CharacterSelection_Clean_C, AllowKeyInput) == 0x00036A, "Member 'USCREEN_CharacterSelection_Clean_C::AllowKeyInput' has a wrong offset!");
