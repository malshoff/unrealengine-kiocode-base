...
#include "HUD_CrosNewMinigun_classes.hpp"
#include "HUD_CrosNewMinigun_parameters.hpp"
...
void UHUD_CrosNewMinigun_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "SetData");

	Params::HUD_CrosNewMinigun_C_SetData Parms{};
...
void UHUD_CrosNewMinigun_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "OnSpreadChanged");

	Params::HUD_CrosNewMinigun_C_OnSpreadChanged Parms{};
...
void UHUD_CrosNewMinigun_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "Construct");
...
void UHUD_CrosNewMinigun_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "PreConstruct");

	Params::HUD_CrosNewMinigun_C_PreConstruct Parms{};
...
void UHUD_CrosNewMinigun_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "OnDamagedEnemy_Event");

	Params::HUD_CrosNewMinigun_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CrosNewMinigun_C::ExecuteUbergraph_HUD_CrosNewMinigun(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewMinigun_C", "ExecuteUbergraph_HUD_CrosNewMinigun");

	Params::HUD_CrosNewMinigun_C_ExecuteUbergraph_HUD_CrosNewMinigun Parms{};
