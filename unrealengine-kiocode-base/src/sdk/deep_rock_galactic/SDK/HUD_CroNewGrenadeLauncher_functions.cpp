...
#include "HUD_CroNewGrenadeLauncher_classes.hpp"
#include "HUD_CroNewGrenadeLauncher_parameters.hpp"
...
void UHUD_CroNewGrenadeLauncher_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "PreConstruct");

	Params::HUD_CroNewGrenadeLauncher_C_PreConstruct Parms{};
...
void UHUD_CroNewGrenadeLauncher_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "OnDamagedEnemy_Event");

	Params::HUD_CroNewGrenadeLauncher_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CroNewGrenadeLauncher_C::SwitchToHP()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "SwitchToHP");
...
void UHUD_CroNewGrenadeLauncher_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "SetData");

	Params::HUD_CroNewGrenadeLauncher_C_SetData Parms{};
...
void UHUD_CroNewGrenadeLauncher_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "Construct");
...
void UHUD_CroNewGrenadeLauncher_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "OnSpreadChanged");

	Params::HUD_CroNewGrenadeLauncher_C_OnSpreadChanged Parms{};
...
void UHUD_CroNewGrenadeLauncher_C::ExecuteUbergraph_HUD_CroNewGrenadeLauncher(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroNewGrenadeLauncher_C", "ExecuteUbergraph_HUD_CroNewGrenadeLauncher");

	Params::HUD_CroNewGrenadeLauncher_C_ExecuteUbergraph_HUD_CroNewGrenadeLauncher Parms{};
