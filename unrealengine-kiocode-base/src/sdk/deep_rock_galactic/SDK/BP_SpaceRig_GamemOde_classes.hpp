...
static_assert(sizeof(ABP_SpaceRig_Gamemode_C) == 0x000530, "Wrong size on ABP_SpaceRig_Gamemode_C");
static_assert(offsetof(ABP_SpaceRig_Gamemode_C, UberGraphFrame) == 0x000518, "Member 'ABP_SpaceRig_Gamemode_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_SpaceRig_Gamemode_C, DifficultyManager) == 0x000520, "Member 'ABP_SpaceRig_Gamemode_C::DifficultyManager' has a wrong offset!");
static_assert(offsetof(ABP_SpaceRig_Gamemode_C, DefaultSceneRoot) == 0x000528, "Member 'ABP_SpaceRig_Gamemode_C::DefaultSceneRoot' has a wrong offset!");
