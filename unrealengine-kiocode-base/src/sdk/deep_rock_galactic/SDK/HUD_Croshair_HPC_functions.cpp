...
#include "HUD_Croshair_HPC_classes.hpp"
#include "HUD_Croshair_HPC_parameters.hpp"
...
void UHUD_Croshair_HPC_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "SetData");

	Params::HUD_Croshair_HPC_C_SetData Parms{};
...
void UHUD_Croshair_HPC_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "OnDamagedEnemy_Event");

	Params::HUD_Croshair_HPC_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_Croshair_HPC_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "PreConstruct");

	Params::HUD_Croshair_HPC_C_PreConstruct Parms{};
...
// Function HUD_Croshair_HPC.HUD_Croshair_HPC_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
...
void UHUD_Croshair_HPC_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "Construct");
...
void UHUD_Croshair_HPC_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "OnSpreadChanged");

	Params::HUD_Croshair_HPC_C_OnSpreadChanged Parms{};
...
void UHUD_Croshair_HPC_C::OnClipCountChanged(int32 Amount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "OnClipCountChanged");

	Params::HUD_Croshair_HPC_C_OnClipCountChanged Parms{};
...
void UHUD_Croshair_HPC_C::OnBoosterActived(bool IsActive)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "OnBoosterActived");

	Params::HUD_Croshair_HPC_C_OnBoosterActived Parms{};
...
void UHUD_Croshair_HPC_C::ExecuteUbergraph_HUD_Croshair_HPC(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Croshair_HPC_C", "ExecuteUbergraph_HUD_Croshair_HPC");

	Params::HUD_Croshair_HPC_C_ExecuteUbergraph_HUD_Croshair_HPC Parms{};
