...
// Function BP_JetBootsMovement.BP_JetBootsMovement_C.HUDWidgetActivated
// (BlueprintCallable, BlueprintEvent)

void UBP_JetBootsMovement_C::HUDWidgetActivated()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_JetBootsMovement_C", "HUDWidgetActivated");
