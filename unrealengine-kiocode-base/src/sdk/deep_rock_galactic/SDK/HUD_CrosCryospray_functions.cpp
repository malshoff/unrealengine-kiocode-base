...
#include "HUD_CrosCryospray_classes.hpp"
#include "HUD_CrosCryospray_parameters.hpp"
...
void UHUD_CrosCryospray_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "SetData");

	Params::HUD_CrosCryospray_C_SetData Parms{};
...
void UHUD_CrosCryospray_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "Construct");
...
void UHUD_CrosCryospray_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "OnSpreadChanged");

	Params::HUD_CrosCryospray_C_OnSpreadChanged Parms{};
...
void UHUD_CrosCryospray_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "PreConstruct");

	Params::HUD_CrosCryospray_C_PreConstruct Parms{};
...
void UHUD_CrosCryospray_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "OnDamagedEnemy_Event");

	Params::HUD_CrosCryospray_C_OnDamagedEnemy_Event Parms{};
...
// Function HUD_CrosCryospray.HUD_CrosCryospray_C.SwitchToBeam
// (BlueprintCallable, BlueprintEvent)

void UHUD_CrosCryospray_C::SwitchToBeam()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "SwitchToBeam");
...
void UHUD_CrosCryospray_C::ExecuteUbergraph_HUD_CrosCryospray(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosCryospray_C", "ExecuteUbergraph_HUD_CrosCryospray");

	Params::HUD_CrosCryospray_C_ExecuteUbergraph_HUD_CrosCryospray Parms{};
