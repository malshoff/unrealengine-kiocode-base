...
// Parameters:
// bool                                    InBusy                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UITM_GeneratedIcon_Item_C::ShowBusy(bool InBusy)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ITM_GeneratedIcon_Item_C", "ShowBusy");

	Params::ITM_GeneratedIcon_Item_C_ShowBusy Parms{};
...
// class UPlayerCharacterID*               Character                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FName                             CancelGroup                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UITM_GeneratedIcon_Item_C::ShowAsItem(class UVanityItem* Item, class UPlayerCharacterID* Character, class FName CancelGroup)
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstanceDynamic* UITM_GeneratedIcon_Item_C::GetRenderTarget()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ITM_GeneratedIcon_Item_C", "GetRenderTarget");

	Params::ITM_GeneratedIcon_Item_C_GetRenderTarget Parms{};
