...
#include "HUD_RadarPoint_EscapePod_classes.hpp"
#include "HUD_RadarPoint_EscapePod_parameters.hpp"
...
void UHUD_RadarPoint_EscapePod_C::InitPoint(class URadarPointComponent* RadarComponent, bool* Success)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_RadarPoint_EscapePod_C", "InitPoint");

	Params::HUD_RadarPoint_EscapePod_C_InitPoint Parms{};
...
void UHUD_RadarPoint_EscapePod_C::Get3dPosition(struct FVector* Pos)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_RadarPoint_EscapePod_C", "Get3dPosition");

	Params::HUD_RadarPoint_EscapePod_C_Get3dPosition Parms{};
...
void UHUD_RadarPoint_EscapePod_C::UpdatePoint(float Alpha, float VerticalDist, bool* Destroy)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_RadarPoint_EscapePod_C", "UpdatePoint");

	Params::HUD_RadarPoint_EscapePod_C_UpdatePoint Parms{};
