...
#include "HUD_CroBurstPistol_classes.hpp"
#include "HUD_CroBurstPistol_parameters.hpp"
...
void UHUD_CroBurstPistol_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "Construct");
...
void UHUD_CroBurstPistol_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "SetData");

	Params::HUD_CroBurstPistol_C_SetData Parms{};
...
void UHUD_CroBurstPistol_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "OnSpreadChanged");

	Params::HUD_CroBurstPistol_C_OnSpreadChanged Parms{};
...
void UHUD_CroBurstPistol_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "PreConstruct");

	Params::HUD_CroBurstPistol_C_PreConstruct Parms{};
...
void UHUD_CroBurstPistol_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "OnDamagedEnemy_Event");

	Params::HUD_CroBurstPistol_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CroBurstPistol_C::ExecuteUbergraph_HUD_CroBurstPistol(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CroBurstPistol_C", "ExecuteUbergraph_HUD_CroBurstPistol");

	Params::HUD_CroBurstPistol_C_ExecuteUbergraph_HUD_CroBurstPistol Parms{};
