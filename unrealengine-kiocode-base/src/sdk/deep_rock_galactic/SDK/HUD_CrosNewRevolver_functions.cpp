...
#include "HUD_CrosNewRevolver_classes.hpp"
#include "HUD_CrosNewRevolver_parameters.hpp"
...
void UHUD_CrosNewRevolver_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "Construct");
...
void UHUD_CrosNewRevolver_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "SetData");

	Params::HUD_CrosNewRevolver_C_SetData Parms{};
...
void UHUD_CrosNewRevolver_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "OnSpreadChanged");

	Params::HUD_CrosNewRevolver_C_OnSpreadChanged Parms{};
...
void UHUD_CrosNewRevolver_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "PreConstruct");

	Params::HUD_CrosNewRevolver_C_PreConstruct Parms{};
...
void UHUD_CrosNewRevolver_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "OnDamagedEnemy_Event");

	Params::HUD_CrosNewRevolver_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_CrosNewRevolver_C::ExecuteUbergraph_HUD_CrosNewRevolver(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_CrosNewRevolver_C", "ExecuteUbergraph_HUD_CrosNewRevolver");

	Params::HUD_CrosNewRevolver_C_ExecuteUbergraph_HUD_CrosNewRevolver Parms{};
