...
#include "HUD_Cro_CoilGun_classes.hpp"
#include "HUD_Cro_CoilGun_parameters.hpp"
...
void UHUD_Cro_CoilGun_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "Construct");
...
void UHUD_Cro_CoilGun_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "SetData");

	Params::HUD_Cro_CoilGun_C_SetData Parms{};
...
void UHUD_Cro_CoilGun_C::OnSpreadChanged(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "OnSpreadChanged");

	Params::HUD_Cro_CoilGun_C_OnSpreadChanged Parms{};
...
void UHUD_Cro_CoilGun_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "PreConstruct");

	Params::HUD_Cro_CoilGun_C_PreConstruct Parms{};
...
void UHUD_Cro_CoilGun_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "OnDamagedEnemy_Event");

	Params::HUD_Cro_CoilGun_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_Cro_CoilGun_C::OnChargeChanged(float Charge)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "OnChargeChanged");

	Params::HUD_Cro_CoilGun_C_OnChargeChanged Parms{};
...
void UHUD_Cro_CoilGun_C::ExecuteUbergraph_HUD_Cro_CoilGun(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_CoilGun_C", "ExecuteUbergraph_HUD_Cro_CoilGun");

	Params::HUD_Cro_CoilGun_C_ExecuteUbergraph_HUD_Cro_CoilGun Parms{};
