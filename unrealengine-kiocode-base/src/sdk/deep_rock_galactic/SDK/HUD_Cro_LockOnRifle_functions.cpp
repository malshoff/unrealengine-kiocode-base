...
#include "HUD_Cro_LockOnRifle_classes.hpp"
#include "HUD_Cro_LockOnRifle_parameters.hpp"
...
void UHUD_Cro_LockOnRifle_C::OnSpreadChange(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "OnSpreadChange");

	Params::HUD_Cro_LockOnRifle_C_OnSpreadChange Parms{};
...
void UHUD_Cro_LockOnRifle_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "Construct");
...
void UHUD_Cro_LockOnRifle_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "SetData");

	Params::HUD_Cro_LockOnRifle_C_SetData Parms{};
...
void UHUD_Cro_LockOnRifle_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "PreConstruct");

	Params::HUD_Cro_LockOnRifle_C_PreConstruct Parms{};
...
void UHUD_Cro_LockOnRifle_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "OnDamagedEnemy_Event");

	Params::HUD_Cro_LockOnRifle_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_Cro_LockOnRifle_C::LockingStarted_Event()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "LockingStarted_Event");
...
void UHUD_Cro_LockOnRifle_C::NoLongerFocussed()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "NoLongerFocussed");
...
void UHUD_Cro_LockOnRifle_C::OnUpgraded(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "OnUpgraded");

	Params::HUD_Cro_LockOnRifle_C_OnUpgraded Parms{};
...
void UHUD_Cro_LockOnRifle_C::OnLockingStopped()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "OnLockingStopped");

	UObject::ProcessEvent(Func, nullptr);
}


// Function HUD_Cro_LockOnRifle.HUD_Cro_LockOnRifle_C.OnLockingAboutToExpire
// (BlueprintCallable, BlueprintEvent)

void UHUD_Cro_LockOnRifle_C::OnLockingAboutToExpire()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "OnLockingAboutToExpire");
...
void UHUD_Cro_LockOnRifle_C::ExecuteUbergraph_HUD_Cro_LockOnRifle(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_LockOnRifle_C", "ExecuteUbergraph_HUD_Cro_LockOnRifle");

	Params::HUD_Cro_LockOnRifle_C_ExecuteUbergraph_HUD_Cro_LockOnRifle Parms{};
