...
#include "HUD_Cro_BoltActionRifle_classes.hpp"
#include "HUD_Cro_BoltActionRifle_parameters.hpp"
...
void UHUD_Cro_BoltActionRifle_C::OnSpreadChange(float HorizontalSpread, float VerticalSpread, bool IsAtRest)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "OnSpreadChange");

	Params::HUD_Cro_BoltActionRifle_C_OnSpreadChange Parms{};
...
void UHUD_Cro_BoltActionRifle_C::Construct()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "Construct");
...
void UHUD_Cro_BoltActionRifle_C::SetData(class AItem* Item)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "SetData");

	Params::HUD_Cro_BoltActionRifle_C_SetData Parms{};
...
void UHUD_Cro_BoltActionRifle_C::PreConstruct(bool IsDesignTime)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "PreConstruct");

	Params::HUD_Cro_BoltActionRifle_C_PreConstruct Parms{};
...
void UHUD_Cro_BoltActionRifle_C::OnDamagedEnemy_Event(const TScriptInterface<class IHealth>& EnemyHealth, float Damage, float DamageModifier, float HealthRemaining, bool IsWeakPoint, bool IsRadial)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "OnDamagedEnemy_Event");

	Params::HUD_Cro_BoltActionRifle_C_OnDamagedEnemy_Event Parms{};
...
void UHUD_Cro_BoltActionRifle_C::ExecuteUbergraph_HUD_Cro_BoltActionRifle(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("HUD_Cro_BoltActionRifle_C", "ExecuteUbergraph_HUD_Cro_BoltActionRifle");

	Params::HUD_Cro_BoltActionRifle_C_ExecuteUbergraph_HUD_Cro_BoltActionRifle Parms{};
