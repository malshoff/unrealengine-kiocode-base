...
class U_MENU_Crafting_C final : public UWindowWidget
{
public:
	...
	class UBasic_Menu_ColorBar_C*                 BasicWindow_ColorBar_C_0;                          // 0x02B0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                         Pad_5313[0x7];                                     // 0x0301(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetNextAvailableRank(TArray<class UVanityItem*>& In_Vanity_Items, int32* VisibleRank);
	struct FEventReply OnKeyUp(const struct FGeometry& MyGeometry, const struct FKeyEvent& InKeyEvent);
	void PrevGroup();
	void NextGroup();
	void ClearItems();
	void ShowItems(EVanitySlot Param_Slot);
	void Construct();
	...
	void BndEvt__ClassSelector_K2Node_ComponentBoundEvent_0_OnCharacterChanged__DelegateSignature(class UClass* Param_Character);
	void OnShown();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"_MENU_Crafting_C">();
	}
	static class U_MENU_Crafting_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<U_MENU_Crafting_C>();
	}
};
static_assert(alignof(U_MENU_Crafting_C) == 0x000008, "Wrong alignment on U_MENU_Crafting_C");
static_assert(sizeof(U_MENU_Crafting_C) == 0x000318, "Wrong size on U_MENU_Crafting_C");
static_assert(offsetof(U_MENU_Crafting_C, UberGraphFrame) == 0x0002A0, "Member 'U_MENU_Crafting_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, BasicScrollBarBox) == 0x0002A8, "Member 'U_MENU_Crafting_C::BasicScrollBarBox' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, BasicWindow_ColorBar_C_0) == 0x0002B0, "Member 'U_MENU_Crafting_C::BasicWindow_ColorBar_C_0' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, BlurBackground) == 0x0002B8, "Member 'U_MENU_Crafting_C::BlurBackground' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ClassSelector) == 0x0002C0, "Member 'U_MENU_Crafting_C::ClassSelector' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, DATA_CategoryName) == 0x0002C8, "Member 'U_MENU_Crafting_C::DATA_CategoryName' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ITM_DragRotateCharacter) == 0x0002D0, "Member 'U_MENU_Crafting_C::ITM_DragRotateCharacter' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ITM_ItemCategories) == 0x0002D8, "Member 'U_MENU_Crafting_C::ITM_ItemCategories' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ITM_LoadoutSelectorBar) == 0x0002E0, "Member 'U_MENU_Crafting_C::ITM_LoadoutSelectorBar' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, MasteryBar) == 0x0002E8, "Member 'U_MENU_Crafting_C::MasteryBar' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, MENU_SpaceRigTemplate) == 0x0002F0, "Member 'U_MENU_Crafting_C::MENU_SpaceRigTemplate' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ScrollHolder) == 0x0002F8, "Member 'U_MENU_Crafting_C::ScrollHolder' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, CurrentSlot) == 0x000300, "Member 'U_MENU_Crafting_C::CurrentSlot' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, ActiveButton) == 0x000308, "Member 'U_MENU_Crafting_C::ActiveButton' has a wrong offset!");
static_assert(offsetof(U_MENU_Crafting_C, Character) == 0x000310, "Member 'U_MENU_Crafting_C::Character' has a wrong offset!");
