...
static_assert(sizeof(UMagicLeapARPinComponent) == 0x000320, "Wrong size on UMagicLeapARPinComponent");
static_assert(offsetof(UMagicLeapARPinComponent, ObjectUID) == 0x0001F0, "Member 'UMagicLeapARPinComponent::ObjectUID' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, UserIndex) == 0x000200, "Member 'UMagicLeapARPinComponent::UserIndex' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, AutoPinType) == 0x000204, "Member 'UMagicLeapARPinComponent::AutoPinType' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, bShouldPinActor) == 0x000205, "Member 'UMagicLeapARPinComponent::bShouldPinActor' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinDataClass) == 0x000208, "Member 'UMagicLeapARPinComponent::PinDataClass' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, OnPersistentEntityPinned) == 0x000210, "Member 'UMagicLeapARPinComponent::OnPersistentEntityPinned' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, OnPersistentEntityPinLost) == 0x000220, "Member 'UMagicLeapARPinComponent::OnPersistentEntityPinLost' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinnedCFUID) == 0x000230, "Member 'UMagicLeapARPinComponent::PinnedCFUID' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinnedSceneComponent) == 0x000240, "Member 'UMagicLeapARPinComponent::PinnedSceneComponent' has a wrong offset!");
static_assert(offsetof(UMagicLeapARPinComponent, PinData) == 0x000248, "Member 'UMagicLeapARPinComponent::PinData' has a wrong offset!");
