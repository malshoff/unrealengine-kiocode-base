...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_ServerBadge_C">();
	}
...
static_assert(alignof(UWBP_ServerBadge_C) == 0x000008, "Wrong alignment on UWBP_ServerBadge_C");
static_assert(sizeof(UWBP_ServerBadge_C) == 0x0002D8, "Wrong size on UWBP_ServerBadge_C");
static_assert(offsetof(UWBP_ServerBadge_C, UberGraphFrame) == 0x000230, "Member 'UWBP_ServerBadge_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBadge_C, BadgeIcon) == 0x000238, "Member 'UWBP_ServerBadge_C::BadgeIcon' has a wrong offset!");
static_assert(offsetof(UWBP_ServerBadge_C, BadgeUIDefinition) == 0x000240, "Member 'UWBP_ServerBadge_C::BadgeUIDefinition' has a wrong offset!");
