...
{
public:
	uint8                                         Pad_12EE[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12EF[0x120];                                   // 0x0048(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F0[0x7];                                     // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<EConstructionSystemToolType, class UConstructionSystemTool*> Tools;                                             // 0x00F8(0x0050)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_12F1[0x8];                                     // 0x0148(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F3[0x4];                                     // 0x002C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F4[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12F5[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F6[0x54];                                    // 0x003C(0x0054)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F7[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12F8[0x3];                                     // 0x043D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12F9[0xC];                                     // 0x0444(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPrefabricatorConstructionSnapComponent) == 0x000450, "Wrong size on UPrefabricatorConstructionSnapComponent");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, SnapType) == 0x000430, "Member 'UPrefabricatorConstructionSnapComponent::SnapType' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, FloorConstraint) == 0x000431, "Member 'UPrefabricatorConstructionSnapComponent::FloorConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, WallConstraint) == 0x000437, "Member 'UPrefabricatorConstructionSnapComponent::WallConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, bAlignToGroundSlope) == 0x00043B, "Member 'UPrefabricatorConstructionSnapComponent::bAlignToGroundSlope' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, bUseMaxGroundSlopeConstraint) == 0x00043C, "Member 'UPrefabricatorConstructionSnapComponent::bUseMaxGroundSlopeConstraint' has a wrong offset!");
static_assert(offsetof(UPrefabricatorConstructionSnapComponent, MaxGroundPlacementSlope) == 0x000440, "Member 'UPrefabricatorConstructionSnapComponent::MaxGroundPlacementSlope' has a wrong offset!");
...
static_assert(sizeof(APrefabricatorConstructionSnap) == 0x000228, "Wrong size on APrefabricatorConstructionSnap");
static_assert(offsetof(APrefabricatorConstructionSnap, ConstructionSnapComponent) == 0x000220, "Member 'APrefabricatorConstructionSnap::ConstructionSnapComponent' has a wrong offset!");
