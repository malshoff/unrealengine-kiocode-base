...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BPI_RadialInput_C">();
	}
...
static_assert(alignof(IBPI_RadialInput_C) == 0x000008, "Wrong alignment on IBPI_RadialInput_C");
static_assert(sizeof(IBPI_RadialInput_C) == 0x000028, "Wrong size on IBPI_RadialInput_C");
