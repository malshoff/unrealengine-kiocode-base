...
{
public:
	uint8                                         Pad_13A1[0x8];                                     // 0x07D0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_13A2[0x2C];                                    // 0x07E4(0x002C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAudioCurveSourceComponent, CurveSourceBindingName) == 0x0007D8, "Member 'UAudioCurveSourceComponent::CurveSourceBindingName' has a wrong offset!");
static_assert(offsetof(UAudioCurveSourceComponent, CurveSyncOffset) == 0x0007E0, "Member 'UAudioCurveSourceComponent::CurveSyncOffset' has a wrong offset!");
