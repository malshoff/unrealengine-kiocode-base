...
bool AFantasticPerspectiveActor::Apply(class APlayerController* PlayerController, const EFantasticPerspectiveStereoscopicPass StereoPass, const struct FVector& ViewOrigin, const struct FMatrix& ViewRotationMatrix, const struct FMatrix& ProjectionMatrix, struct FVector* OutViewOrigin, struct FMatrix* OutViewRotationMatrix, struct FMatrix* OutProjectionMatrix)
{
	...
	if (OutViewOrigin != nullptr)
		*OutViewOrigin = std::move(Parms.OutViewOrigin);

	if (OutViewRotationMatrix != nullptr)
		*OutViewRotationMatrix = std::move(Parms.OutViewRotationMatrix);

	if (OutProjectionMatrix != nullptr)
		*OutProjectionMatrix = std::move(Parms.OutProjectionMatrix);
...
bool UFantasticPerspectiveComponent::Apply(class APlayerController* PlayerController, const EFantasticPerspectiveStereoscopicPass StereoPass, const struct FVector& ViewOrigin, const struct FMatrix& ViewRotationMatrix, const struct FMatrix& ProjectionMatrix, struct FVector* OutViewOrigin, struct FMatrix* OutViewRotationMatrix, struct FMatrix* OutProjectionMatrix)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::ApplySettingsAndDrawDebug(const class UObject* WorldContextObject, const struct FFantasticPerspectiveSettings& Settings, const struct FVector& ViewOrigin, const struct FMatrix& ViewRotationMatrix, const struct FMatrix& ProjectionMatrix, struct FVector* OutViewOrigin, struct FMatrix* OutViewRotationMatrix, struct FMatrix* OutProjectionMatrix)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::ApplyToSceneCapture2D(class USceneCaptureComponent2D* SceneCapture, const struct FVector& ViewOrigin, const struct FMatrix& ViewRotationMatrix, const struct FMatrix& ProjectionMatrix)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::DrawDebugPositionedFrustum(const class UObject* WorldContextObject, const struct FVector& ViewOrigin, const struct FMatrix& ViewRotationMatrix, const struct FMatrix& ProjectionMatrix, const struct FLinearColor& Color, float PerspectiveFrustumDepth, bool bPersistentLines, float LifeTime, uint8 DepthPriority, float Thickness)
{
	static class UFunction* Func = nullptr;
...
const struct FFantasticPerspectiveDebug UFantasticPerspectiveFunctions::GetDebugSettings(const struct FFantasticPerspectiveSettings& Target)
{
	static class UFunction* Func = nullptr;
...
const struct FFantasticPerspectiveFrustum UFantasticPerspectiveFunctions::GetFrustumSettings(const struct FFantasticPerspectiveSettings& Target)
{
	static class UFunction* Func = nullptr;
...
const struct FFantasticPerspectiveTransform UFantasticPerspectiveFunctions::GetTransformSettings(const struct FFantasticPerspectiveSettings& Target)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::SetDebugSettings(struct FFantasticPerspectiveSettings& Target, const struct FFantasticPerspectiveDebug& Debug)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::SetFrustumSettings(struct FFantasticPerspectiveSettings& Target, const struct FFantasticPerspectiveFrustum& Frustum)
{
	static class UFunction* Func = nullptr;
...
void UFantasticPerspectiveFunctions::SetTransformSettings(struct FFantasticPerspectiveSettings& Target, const struct FFantasticPerspectiveTransform& Transform)
{
	static class UFunction* Func = nullptr;
