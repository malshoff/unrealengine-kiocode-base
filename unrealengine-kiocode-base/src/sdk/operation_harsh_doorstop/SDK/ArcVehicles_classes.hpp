...
static_assert(alignof(AArcVehiclePawn) == 0x000008, "Wrong alignment on AArcVehiclePawn");
static_assert(sizeof(AArcVehiclePawn) == 0x000280, "Wrong size on AArcVehiclePawn");
...
static_assert(alignof(UArcVehiclePlayerSeatComponent) == 0x000008, "Wrong alignment on UArcVehiclePlayerSeatComponent");
static_assert(sizeof(UArcVehiclePlayerSeatComponent) == 0x000198, "Wrong size on UArcVehiclePlayerSeatComponent");
static_assert(offsetof(UArcVehiclePlayerSeatComponent, CurrentSeatConfig) == 0x0000B0, "Member 'UArcVehiclePlayerSeatComponent::CurrentSeatConfig' has a wrong offset!");
static_assert(offsetof(UArcVehiclePlayerSeatComponent, PreviousSeatConfig) == 0x0000C0, "Member 'UArcVehiclePlayerSeatComponent::PreviousSeatConfig' has a wrong offset!");
static_assert(offsetof(UArcVehiclePlayerSeatComponent, StoredPlayerState) == 0x0000D0, "Member 'UArcVehiclePlayerSeatComponent::StoredPlayerState' has a wrong offset!");
static_assert(offsetof(UArcVehiclePlayerSeatComponent, ServerDebugStrings) == 0x000130, "Member 'UArcVehiclePlayerSeatComponent::ServerDebugStrings' has a wrong offset!");
static_assert(offsetof(UArcVehiclePlayerSeatComponent, PreviousVehicleCollisionResponses) == 0x000148, "Member 'UArcVehiclePlayerSeatComponent::PreviousVehicleCollisionResponses' has a wrong offset!");
...
static_assert(alignof(AArcBaseVehicle) == 0x000008, "Wrong alignment on AArcBaseVehicle");
static_assert(sizeof(AArcBaseVehicle) == 0x0002C8, "Wrong size on AArcBaseVehicle");
static_assert(offsetof(AArcBaseVehicle, DriverSeatConfig) == 0x000280, "Member 'AArcBaseVehicle::DriverSeatConfig' has a wrong offset!");
static_assert(offsetof(AArcBaseVehicle, AdditionalSeatConfigs) == 0x000288, "Member 'AArcBaseVehicle::AdditionalSeatConfigs' has a wrong offset!");
static_assert(offsetof(AArcBaseVehicle, ReplicatedSeatConfigs) == 0x000298, "Member 'AArcBaseVehicle::ReplicatedSeatConfigs' has a wrong offset!");
static_assert(offsetof(AArcBaseVehicle, SeatChangeQueue) == 0x0002A8, "Member 'AArcBaseVehicle::SeatChangeQueue' has a wrong offset!");
static_assert(offsetof(AArcBaseVehicle, ServerDebugStrings) == 0x0002B8, "Member 'AArcBaseVehicle::ServerDebugStrings' has a wrong offset!");
...
static_assert(alignof(UArcVehicleBPFunctionLibrary) == 0x000008, "Wrong alignment on UArcVehicleBPFunctionLibrary");
static_assert(sizeof(UArcVehicleBPFunctionLibrary) == 0x000028, "Wrong size on UArcVehicleBPFunctionLibrary");
...
static_assert(alignof(UArcVehicleDeveloperSettings) == 0x000008, "Wrong alignment on UArcVehicleDeveloperSettings");
static_assert(sizeof(UArcVehicleDeveloperSettings) == 0x000048, "Wrong size on UArcVehicleDeveloperSettings");
static_assert(offsetof(UArcVehicleDeveloperSettings, PlayerSeatComponentClass) == 0x000038, "Member 'UArcVehicleDeveloperSettings::PlayerSeatComponentClass' has a wrong offset!");
static_assert(offsetof(UArcVehicleDeveloperSettings, PlayerStateComponentClass) == 0x000040, "Member 'UArcVehicleDeveloperSettings::PlayerStateComponentClass' has a wrong offset!");
...
static_assert(alignof(UArcVehicleEngineSubsystem) == 0x000008, "Wrong alignment on UArcVehicleEngineSubsystem");
static_assert(sizeof(UArcVehicleEngineSubsystem) == 0x000040, "Wrong size on UArcVehicleEngineSubsystem");
...
static_assert(alignof(UArcVehicleExitPoint) == 0x000010, "Wrong alignment on UArcVehicleExitPoint");
static_assert(sizeof(UArcVehicleExitPoint) == 0x0001F0, "Wrong size on UArcVehicleExitPoint");
...
static_assert(alignof(UArcVehiclePlayerStateComponent) == 0x000008, "Wrong alignment on UArcVehiclePlayerStateComponent");
static_assert(sizeof(UArcVehiclePlayerStateComponent) == 0x0000B8, "Wrong size on UArcVehiclePlayerStateComponent");
static_assert(offsetof(UArcVehiclePlayerStateComponent, StoredPlayerPawn) == 0x0000B0, "Member 'UArcVehiclePlayerStateComponent::StoredPlayerPawn' has a wrong offset!");
...
static_assert(alignof(AArcVehicleSeat) == 0x000008, "Wrong alignment on AArcVehicleSeat");
static_assert(sizeof(AArcVehicleSeat) == 0x000288, "Wrong size on AArcVehicleSeat");
static_assert(offsetof(AArcVehicleSeat, SeatConfig) == 0x000280, "Member 'AArcVehicleSeat::SeatConfig' has a wrong offset!");
...
static_assert(alignof(UArcVehicleSeatConfig) == 0x000008, "Wrong alignment on UArcVehicleSeatConfig");
static_assert(sizeof(UArcVehicleSeatConfig) == 0x0000D8, "Wrong size on UArcVehicleSeatConfig");
static_assert(offsetof(UArcVehicleSeatConfig, AttachSeatToComponent) == 0x0000B0, "Member 'UArcVehicleSeatConfig::AttachSeatToComponent' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig, PlayerInSeat) == 0x0000C0, "Member 'UArcVehicleSeatConfig::PlayerInSeat' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig, PlayerSeatComponent) == 0x0000C8, "Member 'UArcVehicleSeatConfig::PlayerSeatComponent' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig, bPlayerVisible) == 0x0000D0, "Member 'UArcVehicleSeatConfig::bPlayerVisible' has a wrong offset!");
...
static_assert(alignof(UArcVehicleSeatConfig_PlayerAttachment) == 0x000008, "Wrong alignment on UArcVehicleSeatConfig_PlayerAttachment");
static_assert(sizeof(UArcVehicleSeatConfig_PlayerAttachment) == 0x0000D8, "Wrong size on UArcVehicleSeatConfig_PlayerAttachment");
...
static_assert(alignof(UArcVehicleSeatConfig_SeatPawn) == 0x000008, "Wrong alignment on UArcVehicleSeatConfig_SeatPawn");
static_assert(sizeof(UArcVehicleSeatConfig_SeatPawn) == 0x000100, "Wrong size on UArcVehicleSeatConfig_SeatPawn");
static_assert(offsetof(UArcVehicleSeatConfig_SeatPawn, SeatPawnClass) == 0x0000D8, "Member 'UArcVehicleSeatConfig_SeatPawn::SeatPawnClass' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig_SeatPawn, PlayerCharacterAttachToComponent) == 0x0000E0, "Member 'UArcVehicleSeatConfig_SeatPawn::PlayerCharacterAttachToComponent' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig_SeatPawn, bResetControlRotationOnEnter) == 0x0000F0, "Member 'UArcVehicleSeatConfig_SeatPawn::bResetControlRotationOnEnter' has a wrong offset!");
static_assert(offsetof(UArcVehicleSeatConfig_SeatPawn, SeatPawn) == 0x0000F8, "Member 'UArcVehicleSeatConfig_SeatPawn::SeatPawn' has a wrong offset!");
...
static_assert(alignof(UArcVehicleTurretMovementComp) == 0x000010, "Wrong alignment on UArcVehicleTurretMovementComp");
static_assert(sizeof(UArcVehicleTurretMovementComp) == 0x0001C0, "Wrong size on UArcVehicleTurretMovementComp");
static_assert(offsetof(UArcVehicleTurretMovementComp, bIgnoreBaseRotation) == 0x000138, "Member 'UArcVehicleTurretMovementComp::bIgnoreBaseRotation' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, bIgnorePitch) == 0x000139, "Member 'UArcVehicleTurretMovementComp::bIgnorePitch' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, bIgnoreYaw) == 0x00013A, "Member 'UArcVehicleTurretMovementComp::bIgnoreYaw' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, bIgnoreRoll) == 0x00013B, "Member 'UArcVehicleTurretMovementComp::bIgnoreRoll' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, UpdatedPitchComponent) == 0x000140, "Member 'UArcVehicleTurretMovementComp::UpdatedPitchComponent' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, RotationRate) == 0x000148, "Member 'UArcVehicleTurretMovementComp::RotationRate' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, CurrentBase) == 0x000180, "Member 'UArcVehicleTurretMovementComp::CurrentBase' has a wrong offset!");
static_assert(offsetof(UArcVehicleTurretMovementComp, PostPhysicsTickFunction) == 0x000188, "Member 'UArcVehicleTurretMovementComp::PostPhysicsTickFunction' has a wrong offset!");
