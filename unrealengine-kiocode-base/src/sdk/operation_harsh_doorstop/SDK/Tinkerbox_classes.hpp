...
static_assert(alignof(UTBGameUserDeveloperSettings) == 0x000008, "Wrong alignment on UTBGameUserDeveloperSettings");
static_assert(sizeof(UTBGameUserDeveloperSettings) == 0x000098, "Wrong size on UTBGameUserDeveloperSettings");
static_assert(offsetof(UTBGameUserDeveloperSettings, SFXSoundMix) == 0x000038, "Member 'UTBGameUserDeveloperSettings::SFXSoundMix' has a wrong offset!");
static_assert(offsetof(UTBGameUserDeveloperSettings, MusicSoundMix) == 0x000050, "Member 'UTBGameUserDeveloperSettings::MusicSoundMix' has a wrong offset!");
static_assert(offsetof(UTBGameUserDeveloperSettings, VOSoundMix) == 0x000068, "Member 'UTBGameUserDeveloperSettings::VOSoundMix' has a wrong offset!");
static_assert(offsetof(UTBGameUserDeveloperSettings, VoiPSoundMix) == 0x000080, "Member 'UTBGameUserDeveloperSettings::VoiPSoundMix' has a wrong offset!");
...
static_assert(alignof(UTBGameInstance) == 0x000008, "Wrong alignment on UTBGameInstance");
static_assert(sizeof(UTBGameInstance) == 0x0002D8, "Wrong size on UTBGameInstance");
static_assert(offsetof(UTBGameInstance, MainMenu) == 0x000288, "Member 'UTBGameInstance::MainMenu' has a wrong offset!");
static_assert(offsetof(UTBGameInstance, MainMenuClass) == 0x000290, "Member 'UTBGameInstance::MainMenuClass' has a wrong offset!");
static_assert(offsetof(UTBGameInstance, MenuGameMode) == 0x000298, "Member 'UTBGameInstance::MenuGameMode' has a wrong offset!");
static_assert(offsetof(UTBGameInstance, MenuBackgroundMaps) == 0x0002B8, "Member 'UTBGameInstance::MenuBackgroundMaps' has a wrong offset!");
static_assert(offsetof(UTBGameInstance, RCONServerSystem) == 0x0002D0, "Member 'UTBGameInstance::RCONServerSystem' has a wrong offset!");
...
static_assert(alignof(ATBWorldSettings) == 0x000008, "Wrong alignment on ATBWorldSettings");
static_assert(sizeof(ATBWorldSettings) == 0x000518, "Wrong size on ATBWorldSettings");
static_assert(offsetof(ATBWorldSettings, MinimapSettings) == 0x0004C8, "Member 'ATBWorldSettings::MinimapSettings' has a wrong offset!");
static_assert(offsetof(ATBWorldSettings, MinimapImg) == 0x0004F0, "Member 'ATBWorldSettings::MinimapImg' has a wrong offset!");
...
static_assert(alignof(UTBGameUserSettings) == 0x000008, "Wrong alignment on UTBGameUserSettings");
static_assert(sizeof(UTBGameUserSettings) == 0x000AD0, "Wrong size on UTBGameUserSettings");
static_assert(offsetof(UTBGameUserSettings, CustomVersion) == 0x000120, "Member 'UTBGameUserSettings::CustomVersion' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bUseSmoothFrameRate) == 0x000124, "Member 'UTBGameUserSettings::bUseSmoothFrameRate' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredDisplayGamma) == 0x000128, "Member 'UTBGameUserSettings::DesiredDisplayGamma' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredFOV) == 0x00012C, "Member 'UTBGameUserSettings::DesiredFOV' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bUseMotionBlur) == 0x000130, "Member 'UTBGameUserSettings::bUseMotionBlur' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMouseSensitivityX) == 0x000134, "Member 'UTBGameUserSettings::DesiredMouseSensitivityX' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMouseSensitivityY) == 0x000138, "Member 'UTBGameUserSettings::DesiredMouseSensitivityY' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bInvertMousePitch) == 0x00013C, "Member 'UTBGameUserSettings::bInvertMousePitch' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bUseMouseSmoothing) == 0x00013D, "Member 'UTBGameUserSettings::bUseMouseSmoothing' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSwitchFireModeOnReselect) == 0x00013E, "Member 'UTBGameUserSettings::DesiredSwitchFireModeOnReselect' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSwitchFireModeOnReselect) == 0x00013F, "Member 'UTBGameUserSettings::LastConfirmedSwitchFireModeOnReselect' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bUseHeadphoneMode) == 0x000140, "Member 'UTBGameUserSettings::bUseHeadphoneMode' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bAllowSoundInBackground) == 0x000141, "Member 'UTBGameUserSettings::bAllowSoundInBackground' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMasterVolumeLevel) == 0x000144, "Member 'UTBGameUserSettings::DesiredMasterVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMasterVolumeLevel) == 0x000148, "Member 'UTBGameUserSettings::LastConfirmedMasterVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSFXVolumeLevel) == 0x00014C, "Member 'UTBGameUserSettings::DesiredSFXVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSFXVolumeLevel) == 0x000150, "Member 'UTBGameUserSettings::LastConfirmedSFXVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMusicVolumeLevel) == 0x000154, "Member 'UTBGameUserSettings::DesiredMusicVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMusicVolumeLevel) == 0x000158, "Member 'UTBGameUserSettings::LastConfirmedMusicVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredVOVolumeLevel) == 0x00015C, "Member 'UTBGameUserSettings::DesiredVOVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedVOVolumeLevel) == 0x000160, "Member 'UTBGameUserSettings::LastConfirmedVOVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredVoiPVolumeLevel) == 0x000164, "Member 'UTBGameUserSettings::DesiredVoiPVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedVoiPVolumeLevel) == 0x000168, "Member 'UTBGameUserSettings::LastConfirmedVoiPVolumeLevel' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, bPlayerIsChangingKeyBindings) == 0x00016C, "Member 'UTBGameUserSettings::bPlayerIsChangingKeyBindings' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMoveForwardKey) == 0x000170, "Member 'UTBGameUserSettings::DesiredMoveForwardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMoveForwardKey) == 0x000188, "Member 'UTBGameUserSettings::LastConfirmedMoveForwardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMoveBackwardKey) == 0x0001A0, "Member 'UTBGameUserSettings::DesiredMoveBackwardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMoveBackwardKey) == 0x0001B8, "Member 'UTBGameUserSettings::LastConfirmedMoveBackwardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMoveLeftKey) == 0x0001D0, "Member 'UTBGameUserSettings::DesiredMoveLeftKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMoveLeftKey) == 0x0001E8, "Member 'UTBGameUserSettings::LastConfirmedMoveLeftKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredMoveRightKey) == 0x000200, "Member 'UTBGameUserSettings::DesiredMoveRightKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedMoveRightKey) == 0x000218, "Member 'UTBGameUserSettings::LastConfirmedMoveRightKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredLeanLeftKey) == 0x000230, "Member 'UTBGameUserSettings::DesiredLeanLeftKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedLeanLeftKey) == 0x000248, "Member 'UTBGameUserSettings::LastConfirmedLeanLeftKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredLeanLeftToggleKey) == 0x000260, "Member 'UTBGameUserSettings::DesiredLeanLeftToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedLeanLeftToggleKey) == 0x000278, "Member 'UTBGameUserSettings::LastConfirmedLeanLeftToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredLeanRightKey) == 0x000290, "Member 'UTBGameUserSettings::DesiredLeanRightKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedLeanRightKey) == 0x0002A8, "Member 'UTBGameUserSettings::LastConfirmedLeanRightKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredLeanRightToggleKey) == 0x0002C0, "Member 'UTBGameUserSettings::DesiredLeanRightToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedLeanRightToggleKey) == 0x0002D8, "Member 'UTBGameUserSettings::LastConfirmedLeanRightToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSprintKey) == 0x0002F0, "Member 'UTBGameUserSettings::DesiredSprintKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSprintKey) == 0x000308, "Member 'UTBGameUserSettings::LastConfirmedSprintKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSprintToggleKey) == 0x000320, "Member 'UTBGameUserSettings::DesiredSprintToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSprintToggleKey) == 0x000338, "Member 'UTBGameUserSettings::LastConfirmedSprintToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredCrouchKey) == 0x000350, "Member 'UTBGameUserSettings::DesiredCrouchKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedCrouchKey) == 0x000368, "Member 'UTBGameUserSettings::LastConfirmedCrouchKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredCrouchToggleKey) == 0x000380, "Member 'UTBGameUserSettings::DesiredCrouchToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedCrouchToggleKey) == 0x000398, "Member 'UTBGameUserSettings::LastConfirmedCrouchToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredProneKey) == 0x0003B0, "Member 'UTBGameUserSettings::DesiredProneKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedProneKey) == 0x0003C8, "Member 'UTBGameUserSettings::LastConfirmedProneKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredJumpVaultKey) == 0x0003E0, "Member 'UTBGameUserSettings::DesiredJumpVaultKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedJumpVaultKey) == 0x0003F8, "Member 'UTBGameUserSettings::LastConfirmedJumpVaultKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredJumpKey) == 0x000410, "Member 'UTBGameUserSettings::DesiredJumpKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedJumpKey) == 0x000428, "Member 'UTBGameUserSettings::LastConfirmedJumpKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredVaultKey) == 0x000440, "Member 'UTBGameUserSettings::DesiredVaultKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedVaultKey) == 0x000458, "Member 'UTBGameUserSettings::LastConfirmedVaultKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredFireKey) == 0x000470, "Member 'UTBGameUserSettings::DesiredFireKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedFireKey) == 0x000488, "Member 'UTBGameUserSettings::LastConfirmedFireKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSwitchFireModeKey) == 0x0004A0, "Member 'UTBGameUserSettings::DesiredSwitchFireModeKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSwitchFireModeKey) == 0x0004B8, "Member 'UTBGameUserSettings::LastConfirmedSwitchFireModeKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredReloadKey) == 0x0004D0, "Member 'UTBGameUserSettings::DesiredReloadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedReloadKey) == 0x0004E8, "Member 'UTBGameUserSettings::LastConfirmedReloadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredAimKey) == 0x000500, "Member 'UTBGameUserSettings::DesiredAimKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedAimKey) == 0x000518, "Member 'UTBGameUserSettings::LastConfirmedAimKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredAimToggleKey) == 0x000530, "Member 'UTBGameUserSettings::DesiredAimToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedAimToggleKey) == 0x000548, "Member 'UTBGameUserSettings::LastConfirmedAimToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredPointAimToggleKey) == 0x000560, "Member 'UTBGameUserSettings::DesiredPointAimToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedPointAimToggleKey) == 0x000578, "Member 'UTBGameUserSettings::LastConfirmedPointAimToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredCycleWeaponSightsKey) == 0x000590, "Member 'UTBGameUserSettings::DesiredCycleWeaponSightsKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedCycleWeaponSightsKey) == 0x0005A8, "Member 'UTBGameUserSettings::LastConfirmedCycleWeaponSightsKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredNextItemKey) == 0x0005C0, "Member 'UTBGameUserSettings::DesiredNextItemKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedNextItemKey) == 0x0005D8, "Member 'UTBGameUserSettings::LastConfirmedNextItemKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredPreviousItemKey) == 0x0005F0, "Member 'UTBGameUserSettings::DesiredPreviousItemKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedPreviousItemKey) == 0x000608, "Member 'UTBGameUserSettings::LastConfirmedPreviousItemKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot0Key) == 0x000620, "Member 'UTBGameUserSettings::DesiredItemSlot0Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot0Key) == 0x000638, "Member 'UTBGameUserSettings::LastConfirmedItemSlot0Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot1Key) == 0x000650, "Member 'UTBGameUserSettings::DesiredItemSlot1Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot1Key) == 0x000668, "Member 'UTBGameUserSettings::LastConfirmedItemSlot1Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot2Key) == 0x000680, "Member 'UTBGameUserSettings::DesiredItemSlot2Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot2Key) == 0x000698, "Member 'UTBGameUserSettings::LastConfirmedItemSlot2Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot3Key) == 0x0006B0, "Member 'UTBGameUserSettings::DesiredItemSlot3Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot3Key) == 0x0006C8, "Member 'UTBGameUserSettings::LastConfirmedItemSlot3Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot4Key) == 0x0006E0, "Member 'UTBGameUserSettings::DesiredItemSlot4Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot4Key) == 0x0006F8, "Member 'UTBGameUserSettings::LastConfirmedItemSlot4Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot5Key) == 0x000710, "Member 'UTBGameUserSettings::DesiredItemSlot5Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot5Key) == 0x000728, "Member 'UTBGameUserSettings::LastConfirmedItemSlot5Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot6Key) == 0x000740, "Member 'UTBGameUserSettings::DesiredItemSlot6Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot6Key) == 0x000758, "Member 'UTBGameUserSettings::LastConfirmedItemSlot6Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot7Key) == 0x000770, "Member 'UTBGameUserSettings::DesiredItemSlot7Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot7Key) == 0x000788, "Member 'UTBGameUserSettings::LastConfirmedItemSlot7Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot8Key) == 0x0007A0, "Member 'UTBGameUserSettings::DesiredItemSlot8Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot8Key) == 0x0007B8, "Member 'UTBGameUserSettings::LastConfirmedItemSlot8Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredItemSlot9Key) == 0x0007D0, "Member 'UTBGameUserSettings::DesiredItemSlot9Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedItemSlot9Key) == 0x0007E8, "Member 'UTBGameUserSettings::LastConfirmedItemSlot9Key' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredPushToTalkLocalKey) == 0x000800, "Member 'UTBGameUserSettings::DesiredPushToTalkLocalKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedPushToTalkLocalKey) == 0x000818, "Member 'UTBGameUserSettings::LastConfirmedPushToTalkLocalKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredPushToTalkSquadKey) == 0x000830, "Member 'UTBGameUserSettings::DesiredPushToTalkSquadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedPushToTalkSquadKey) == 0x000848, "Member 'UTBGameUserSettings::LastConfirmedPushToTalkSquadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredPushToTalkCommandKey) == 0x000860, "Member 'UTBGameUserSettings::DesiredPushToTalkCommandKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedPushToTalkCommandKey) == 0x000878, "Member 'UTBGameUserSettings::LastConfirmedPushToTalkCommandKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSayAllKey) == 0x000890, "Member 'UTBGameUserSettings::DesiredSayAllKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSayAllKey) == 0x0008A8, "Member 'UTBGameUserSettings::LastConfirmedSayAllKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSayTeamKey) == 0x0008C0, "Member 'UTBGameUserSettings::DesiredSayTeamKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSayTeamKey) == 0x0008D8, "Member 'UTBGameUserSettings::LastConfirmedSayTeamKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredSaySquadKey) == 0x0008F0, "Member 'UTBGameUserSettings::DesiredSaySquadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedSaySquadKey) == 0x000908, "Member 'UTBGameUserSettings::LastConfirmedSaySquadKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredUseKey) == 0x000920, "Member 'UTBGameUserSettings::DesiredUseKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedUseKey) == 0x000938, "Member 'UTBGameUserSettings::LastConfirmedUseKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredShowScoreboardKey) == 0x000950, "Member 'UTBGameUserSettings::DesiredShowScoreboardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedShowScoreboardKey) == 0x000968, "Member 'UTBGameUserSettings::LastConfirmedShowScoreboardKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredDeployMenuKey) == 0x000980, "Member 'UTBGameUserSettings::DesiredDeployMenuKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedDeployMenuKey) == 0x000998, "Member 'UTBGameUserSettings::LastConfirmedDeployMenuKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredRadialMenuKey) == 0x0009B0, "Member 'UTBGameUserSettings::DesiredRadialMenuKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedRadialMenuKey) == 0x0009C8, "Member 'UTBGameUserSettings::LastConfirmedRadialMenuKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredCameraToggleKey) == 0x0009E0, "Member 'UTBGameUserSettings::DesiredCameraToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedCameraToggleKey) == 0x0009F8, "Member 'UTBGameUserSettings::LastConfirmedCameraToggleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredChatHistoryKey) == 0x000A10, "Member 'UTBGameUserSettings::DesiredChatHistoryKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedChatHistoryKey) == 0x000A28, "Member 'UTBGameUserSettings::LastConfirmedChatHistoryKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredVoteYesKey) == 0x000A40, "Member 'UTBGameUserSettings::DesiredVoteYesKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedVoteYesKey) == 0x000A58, "Member 'UTBGameUserSettings::LastConfirmedVoteYesKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredVoteNoKey) == 0x000A70, "Member 'UTBGameUserSettings::DesiredVoteNoKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedVoteNoKey) == 0x000A88, "Member 'UTBGameUserSettings::LastConfirmedVoteNoKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, DesiredConsoleKey) == 0x000AA0, "Member 'UTBGameUserSettings::DesiredConsoleKey' has a wrong offset!");
static_assert(offsetof(UTBGameUserSettings, LastConfirmedConsoleKey) == 0x000AB8, "Member 'UTBGameUserSettings::LastConfirmedConsoleKey' has a wrong offset!");
...
static_assert(alignof(ATBLevelScriptActor) == 0x000008, "Wrong alignment on ATBLevelScriptActor");
static_assert(sizeof(ATBLevelScriptActor) == 0x000228, "Wrong size on ATBLevelScriptActor");
...
static_assert(alignof(UTBVoiceIndicator) == 0x000008, "Wrong alignment on UTBVoiceIndicator");
static_assert(sizeof(UTBVoiceIndicator) == 0x000248, "Wrong size on UTBVoiceIndicator");
static_assert(offsetof(UTBVoiceIndicator, VoiceListingClass) == 0x000230, "Member 'UTBVoiceIndicator::VoiceListingClass' has a wrong offset!");
static_assert(offsetof(UTBVoiceIndicator, ActiveVoiceList) == 0x000238, "Member 'UTBVoiceIndicator::ActiveVoiceList' has a wrong offset!");
static_assert(offsetof(UTBVoiceIndicator, MaxActiveVoices) == 0x000240, "Member 'UTBVoiceIndicator::MaxActiveVoices' has a wrong offset!");
static_assert(offsetof(UTBVoiceIndicator, ActiveVoices) == 0x000244, "Member 'UTBVoiceIndicator::ActiveVoices' has a wrong offset!");
...
static_assert(alignof(UTBVoiceIndicatorListing) == 0x000008, "Wrong alignment on UTBVoiceIndicatorListing");
static_assert(sizeof(UTBVoiceIndicatorListing) == 0x000258, "Wrong size on UTBVoiceIndicatorListing");
static_assert(offsetof(UTBVoiceIndicatorListing, PlayerName) == 0x000230, "Member 'UTBVoiceIndicatorListing::PlayerName' has a wrong offset!");
static_assert(offsetof(UTBVoiceIndicatorListing, ParentMenu) == 0x000238, "Member 'UTBVoiceIndicatorListing::ParentMenu' has a wrong offset!");
