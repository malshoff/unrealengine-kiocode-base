...
static_assert(sizeof(USteamNetConnection) == 0x001B28, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001B20, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
