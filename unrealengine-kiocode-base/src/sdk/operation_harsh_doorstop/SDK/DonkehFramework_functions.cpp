...
void ADFBaseItem::OnEquip(const class ADFBaseItem* LastItem)
{
	static class UFunction* Func = nullptr;
...
void ADFBaseItem::ReceiveOnEquip(const class ADFBaseItem* LastItem)
{
	static class UFunction* Func = nullptr;
...
void ADFBaseItem::ServerStartFire(const struct FVector_NetQuantize& Origin, const struct FVector_NetQuantizeNormal& ShootDir, int32 RandomSeed, float Timestamp, int32 ShotID)
{
	static class UFunction* Func = nullptr;
...
int32 ADFBaseAmmoClip::StoreAmmoInInventory(class UDFInventoryComponent* AmmoStore, int32 AmmoAmt, const TSubclassOf<class ADFBaseAmmoClip>& AmmoType)
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseCharacter::CanDie(float KillingDamage, const struct FDamageEvent& DamageEvent, class AController* Killer, class AActor* DamageCauser) const
{
	static class UFunction* Func = nullptr;
...
class UAnimSequenceBase* ADFBaseCharacter::GetAnimToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseCharacter::GetDamageMultiplierByBoneName(const class FName& BoneName, float* DamageMultiplier) const
{
	static class UFunction* Func = nullptr;
...
class UAnimMontage* ADFBaseCharacter::GetMontageToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseCharacter::IsPerspectiveMesh(const class USkeletalMeshComponent* MeshCompToCheck) const
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseGameMode::BanPlayerById(int32 BannedPlayerId, const class FText& BanReason, float BanDuration)
{
	static class UFunction* Func = nullptr;
...
class ADFTeamState* ADFBaseGameMode::CreateTeam(const class UDFTeamDefinition* NewTeamDef, const uint8 NewTeamIdToUse)
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseGameMode::KickPlayerById(int32 KickedPlayerId, const class FText& KickReason)
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseGameMode::CanRegisterSignificantActor(const class AActor* ActorToRegister, class FString* ActorDenialReason) const
{
	static class UFunction* Func = nullptr;
...
float ADFBaseGameMode::ModifyDamage(float Damage, class AActor* DamagedActor, const struct FDamageEvent& DamageEvent, class AController* EventInstigator, class AActor* DamageCauser) const
{
	static class UFunction* Func = nullptr;
...
class UDFNetworkEventSubsystem* UDFNetworkEventSubsystem::Get(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class ADFTeamState* ADFBaseGameState::GetTeamStateById(const uint8 TeamIdNum) const
{
	static class UFunction* Func = nullptr;
...
void ADFBaseWeapon::ServerFireShot(const struct FVector_NetQuantize& Origin, const struct FVector_NetQuantizeNormal& ShootDir, int32 RandomSeed, float Timestamp, int32 ShotID)
{
	static class UFunction* Func = nullptr;
...
float ADFBaseWeapon::GetAnimPlayLengthToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
class UAnimSequenceBase* ADFBaseWeapon::GetAnimToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
float ADFBaseWeapon::GetMontagePlayLengthToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
class UAnimMontage* ADFBaseWeapon::GetMontageToUseFromPerspectiveAnimPair(const struct FPerspectiveAnim& AnimationPair) const
{
	static class UFunction* Func = nullptr;
...
void ADFBaseGun_Projectile::ServerNotifyCSHit(class ADFBaseProjectile* HitProj, const struct FCSHitInfo& HitInfo, int32 ShotID)
{
	static class UFunction* Func = nullptr;
...
void ADFBaseGun_Projectile::ServerNotifyCSHitPredicted(const struct FCSHitInfo& HitInfo, int32 ShotID)
{
	static class UFunction* Func = nullptr;
...
void ADFBasePlayerCharacter::ServerUse(class AActor* UseTarget, const struct FVector_NetQuantize& UseTraceStart, const struct FVector_NetQuantize& UseTraceEnd)
{
	static class UFunction* Func = nullptr;
...
bool ADFBasePlayerController::InitiateVote(TSubclassOf<class UDFVoteIssue> IssueClass, const struct FDFVoteIssueContext& IssueContext, int32 VoteSelectionIndex, EDFVotingChannel VotingChannel)
{
	static class UFunction* Func = nullptr;
...
void ADFBasePlayerController::ServerNotifyProjCSHit(class ADFBaseProjectile* HitProj, class APawn* HitProjDamageInstigator, const struct FCSHitInfo& HitInfo, int32 ShotID)
{
	static class UFunction* Func = nullptr;
...
struct FDFDamageParams ADFBaseProjectile::GetAdjustedDamageParams(class AActor* OtherActor, const struct FVector& HitLocation) const
{
	static class UFunction* Func = nullptr;
...
bool ADFBaseProjectile::K2_ShouldIgnoreHit(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FHitResult& HitResult) const
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::DoesMapIDSupportGMDefinition(const struct FPrimaryAssetId& MapId, const class UDFGameModeDefinition* GMDef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_CharacterAnimCollection(const struct FCharacterAnimCollection& A, const struct FCharacterAnimCollection& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_CharacterSoundCollection(const struct FCharacterSoundCollection& A, const struct FCharacterSoundCollection& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_PerspectiveAnim(const struct FPerspectiveAnim& A, const struct FPerspectiveAnim& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_PerspectiveAnimSequence(const struct FPerspectiveAnimSequence& A, const struct FPerspectiveAnimSequence& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_PerspectiveSound(const struct FPerspectiveSound& A, const struct FPerspectiveSound& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_WeaponAnim(const struct FWeaponAnim& A, const struct FWeaponAnim& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_WeaponAnimCollection(const struct FWeaponAnimCollection& A, const struct FWeaponAnimCollection& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_WeaponAnimMontage(const struct FWeaponAnimMontage& A, const struct FWeaponAnimMontage& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_WeaponAnimSequence(const struct FWeaponAnimSequence& A, const struct FWeaponAnimSequence& B)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::EqualEqual_WeaponSoundCollection(const struct FWeaponSoundCollection& A, const struct FWeaponSoundCollection& B)
{
	static class UFunction* Func = nullptr;
...
struct FPrimaryAssetId UDFBlueprintFunctions::FindMapIdByDisplayName(const class FText& MapDisplayName, const TArray<struct FPrimaryAssetId>& MapIds)
{
	static class UFunction* Func = nullptr;
...
void UDFBlueprintFunctions::GetDefaultBoundingCylinder(const class AActor* Actor, float* CylinderRadius, float* CylinderHalfHeight)
{
	static class UFunction* Func = nullptr;
...
struct FVector UDFBlueprintFunctions::GetFocalPoint(const class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataDefaultGameMode(const struct FAssetData& WorldAsset, TSoftClassPtr<class UClass>* OutDefaultGameModeRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataDescription(const struct FAssetData& WorldAsset, class FString* OutMapDescription)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataDisplayName(const struct FAssetData& WorldAsset, class FText* OutMapDisplayName)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataGameRulesetClasses(const struct FAssetData& WorldAsset, TSet<TSoftClassPtr<class UClass>>* OutGameRulesetClasses)
{
	static class UFunction* Func = nullptr;
...
class FText UDFBlueprintFunctions::GetMapAssetDataNameForDisplay(const struct FAssetData& WorldAsset)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataPreviewBannerImg(const struct FAssetData& WorldAsset, TSoftObjectPtr<class UTexture2D>* OutMapPreviewBannerImgRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataPreviewImg(const struct FAssetData& WorldAsset, TSoftObjectPtr<class UTexture2D>* OutMapPreviewImgRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDataSupportedGameModes(const struct FAssetData& WorldAsset, TSet<TSoftClassPtr<class UClass>>* OutSupportedGameModes)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDefaultGameMode(const struct FPrimaryAssetId& WorldAssetId, TSoftClassPtr<class UClass>* OutDefaultGameModeRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetDescription(const struct FPrimaryAssetId& WorldAssetId, class FString* OutMapDescription)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetGameRulesetClasses(const struct FPrimaryAssetId& WorldAssetId, TSet<TSoftClassPtr<class UClass>>* OutGameRulesetClasses)
{
	static class UFunction* Func = nullptr;
...
class FText UDFBlueprintFunctions::GetMapAssetNameForDisplay(const struct FPrimaryAssetId& WorldAssetId)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetPreviewBannerImg(const struct FPrimaryAssetId& WorldAssetId, TSoftObjectPtr<class UTexture2D>* OutMapPreviewBannerImgRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetPreviewImg(const struct FPrimaryAssetId& WorldAssetId, TSoftObjectPtr<class UTexture2D>* OutMapPreviewImgRef)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetSupportedGameModes(const struct FPrimaryAssetId& WorldAssetId, TSet<TSoftClassPtr<class UClass>>* OutSupportedGameModes)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::GetMapAssetVisibleInMapSelectUI(const struct FPrimaryAssetId& WorldAssetId, bool* bOutVisibleInMapSelectUI)
{
	static class UFunction* Func = nullptr;
...
int32 UDFBlueprintFunctions::GetNumShotsFiredBPCompat(const struct FRepShotInfo& Counter, const struct FRepShotInfo& PreviousCounter)
{
	static class UFunction* Func = nullptr;
...
int32 UDFBlueprintFunctions::GetShotCounterBPCompat(const struct FRepShotInfo& Counter)
{
	static class UFunction* Func = nullptr;
...
struct FVector UDFBlueprintFunctions::GetTargetLocation(const class AActor* Actor, class AActor* RequestedBy)
{
	static class UFunction* Func = nullptr;
...
uint8 UDFBlueprintFunctions::GetTeamNum(const class AActor* Target)
{
	static class UFunction* Func = nullptr;
...
class ADFTeamState* UDFBlueprintFunctions::GetTeamStateFromTeamId(class UObject* WorldContextObject, const uint8 TeamIdNum)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::HasFiringStopped(const struct FRepShotInfo& Counter)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::HasOptions(const class FString& Options, const TArray<class FString>& Keys, bool bMatchAll)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::IsLocallyPlayerControlled(const class APawn* Pawn)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::IsPendingKillPending(const class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::IsValidActor(const class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
void UDFBlueprintFunctions::PrintTextToLog(class UObject* WorldContextObject, const class FText& InText, ELogVerbosityBP InLogVerbosity, bool bPrintStackTrace)
{
	static class UFunction* Func = nullptr;
...
void UDFBlueprintFunctions::SetTeamNum(class AActor* Target, const uint8 NewTeamNum)
{
	static class UFunction* Func = nullptr;
...
class ADFBaseImpactEffect* UDFBlueprintFunctions::SpawnImpactFXFromDamageEvent(class UObject* WorldContextObject, TSubclassOf<class ADFBaseImpactEffect> ImpactClass, float DamageTaken, const struct FDamageEvent& DamageEvent, const class AActor* HitActor, const class AActor* HitInstigator, const class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
class ADFBaseImpactEffect* UDFBlueprintFunctions::SpawnImpactFXFromHitResult(class UObject* WorldContextObject, TSubclassOf<class ADFBaseImpactEffect> ImpactClass, const struct FHitResult& Impact)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::TextIsEmptyOrWhitespace(const class FText& InText)
{
	static class UFunction* Func = nullptr;
...
bool UDFBlueprintFunctions::WasShotFired(const struct FRepShotInfo& Counter, const struct FRepShotInfo& OtherCounter)
{
	static class UFunction* Func = nullptr;
...
void IDFTeamAgentInterface::EventSetTeamNum(const uint8 NewTeamNum)
{
	static class UFunction* Func = nullptr;
...
void UDFFunctionLibrary::SetEnableAutoBlendOutForActiveMontage(const class UAnimMontage* AnimMontage, const class USkeletalMeshComponent* AnimSourceMesh, bool bNewEnableAutoBlendOut)
{
	static class UFunction* Func = nullptr;
...
void UDFGameRulesetBase::PlayerWounded(class AController* Victim, float DamageAmount, const class UDamageType* DamageType, class AController* InstigatedBy, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
bool UDFInventoryComponent::Add(const class ADFBaseItem* Item)
{
	static class UFunction* Func = nullptr;
...
bool UDFInventoryComponent::Remove(const class ADFBaseItem* Item, bool bDestroyItem)
{
	static class UFunction* Func = nullptr;
...
bool UDFInventoryComponent::Find(const class ADFBaseItem* ItemToCompare, int32* OutIndex) const
{
	static class UFunction* Func = nullptr;
...
bool UDFInventoryComponent::FindItemByClass(const TSubclassOf<class ADFBaseItem>& ItemClass, class ADFBaseItem** OutItem) const
{
	static class UFunction* Func = nullptr;
...
void ADFTeamState::ReceiveInitTeam(const class UDFTeamDefinition* InTeamDef)
{
	static class UFunction* Func = nullptr;
...
bool UDFVotingComponent::InitiateVote(class APlayerState* InvokingPlayer, TSubclassOf<class UDFVoteIssue> IssueClass, const struct FDFVoteIssueContext& IssueContext)
{
	static class UFunction* Func = nullptr;
...
void UDFVotingComponent::OnRep_ActiveVoteInfo(const struct FDFActiveVoteInfo& PreviousValue)
{
	static class UFunction* Func = nullptr;
...
class UDFVotingComponent* UDFVotingStatics::GetGameStateVotingComponent(const class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
class FText UDFVotingStatics::VoteInfoGetPromptTextForDisplay(const struct FDFActiveVoteInfo& VoteInfo)
{
	static class UFunction* Func = nullptr;
...
bool ISpawnPointProviderInterface::CanRestartPlayerFromSpawnPointBP(const struct FSpawnPointDef& SpawnPoint, class AController* Player, TSubclassOf<class APawn> PlayerPawnClass) const
{
	static class UFunction* Func = nullptr;
...
bool ISpawnPointProviderInterface::CanSpawnActorFromSpawnPointBP(const struct FSpawnPointDef& SpawnPoint, TSubclassOf<class AActor> SpawnActorClass) const
{
	static class UFunction* Func = nullptr;
...
bool ISpawnPointProviderInterface::GetSpawnPointCollisionHandlingOverrideBP(const struct FSpawnPointDef& SpawnPoint, ESpawnActorCollisionHandlingMethod* OutSpawnCollisionMethod) const
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::CanRestartPlayerFromAnySpawnPoint(const class UObject* Target, class AController* Player, const TSubclassOf<class APawn>& PlayerPawnClass)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::CanRestartPlayerFromSpawnPoint(const class UObject* Target, const struct FSpawnPointDef& SpawnPoint, class AController* Player, const TSubclassOf<class APawn>& PlayerPawnClass)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::CanSpawnActorFromAnySpawnPoint(const class UObject* Target, const TSubclassOf<class AActor>& SpawnActorClass)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::CanSpawnActorFromSpawnPoint(const class UObject* Target, const struct FSpawnPointDef& SpawnPoint, const TSubclassOf<class AActor>& SpawnActorClass)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::FindSpawnPoint(const class UObject* Target, int32 SpawnPointID, struct FSpawnPointDef* FoundSpawnPoint)
{
	static class UFunction* Func = nullptr;
...
int32 USpawnPointStatics::GetAllSpawnPoints(const class UObject* Target, TArray<struct FSpawnPointDef>* SpawnPoints)
{
	static class UFunction* Func = nullptr;
...
int32 USpawnPointStatics::GetAllSpawnPointTransforms(const class UObject* Target, TArray<struct FTransform>* SpawnPointTransforms)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::GetSpawnPointCollisionHandlingOverride(const class UObject* Target, const struct FSpawnPointDef& SpawnPoint, ESpawnActorCollisionHandlingMethod* OutSpawnCollisionMethod)
{
	static class UFunction* Func = nullptr;
...
bool USpawnPointStatics::SpawnPointExists(const class UObject* Target, int32 SpawnPointID)
{
	static class UFunction* Func = nullptr;
