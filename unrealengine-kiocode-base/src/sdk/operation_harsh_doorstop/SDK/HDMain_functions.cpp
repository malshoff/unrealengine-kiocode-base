...
bool UHDServerListFilterRule::MatchesServer(const class UHDServerListItemData* ListItem) const
{
...
class AHDBaseCapturePoint* UHDAICaptureHandler::FindControlPointClosestToPawn(const TArray<class AHDBaseCapturePoint*>& CPs) const
{
	static class UFunction* Func = nullptr;
...
class AHDBaseCapturePoint* UHDAICaptureHandler::FindControlPointRandom(const TArray<class AHDBaseCapturePoint*>& CPs) const
{
	static class UFunction* Func = nullptr;
...
class FName UHDSQCommChannelState::GetChannelNameForSquad(const class AHDSquadState* Squad)
{
	static class UFunction* Func = nullptr;
...
void UHDAIAimingHandler::EstablishNewTargetFromPerception(const TSubclassOf<class UAISense>& SenseToUse)
{
	static class UFunction* Func = nullptr;
...
void UHDAIAimingHandler::GetActorStimulusData(const class AActor* InActor, struct FVector* OutLocation, float* OutStrength, float* OutAge) const
{
	static class UFunction* Func = nullptr;
...
bool UHDAIAimingHandler::IsCandidateTarget(const class AActor* ActorToCheck) const
{
	static class UFunction* Func = nullptr;
...
bool UHDAIBehState_BasicAASCombat::IsValidAttackSpot(const struct FVector& InAttackSpot)
{
	static class UFunction* Func = nullptr;
...
bool UHDAIBehState_BasicAASCombat::IsValidSafeSpot(const struct FVector& InSafeSpot)
{
	static class UFunction* Func = nullptr;
...
void UHDAIBehaviorHandler::OnOwnerDeath(class APawn* VictimPawn, class AController* VictimController, float KillingDamage, const struct FDamageEvent& DamageEvent, class APawn* InstigatingPawn, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;
...
void UHDServerListView::SetItemFilterRules(const TMap<TSubclassOf<class UHDServerListFilterRule>, struct FHDFilterRuleParams>& FilterRules)
{
	static class UFunction* Func = nullptr;
...
bool UHDServerListView::DoesFilterExcludeListItem(const class UObject* Item) const
{
	static class UFunction* Func = nullptr;
...
class FName UHDTeamCommChannelState::GetChannelNameForCommand(const class AHDTeamState* CmdTeam)
{
	static class UFunction* Func = nullptr;
...
class FName UHDTeamCommChannelState::GetChannelNameForTeam(const class AHDTeamState* Team)
{
	static class UFunction* Func = nullptr;
...
void UHDAIGroupBehaviorHandler::SyncGroupData(const struct FHDAIGroupData& InGroupData)
{
	static class UFunction* Func = nullptr;
...
bool UHDAINavigationHandler::PointsAreEqualXY(const struct FVector& Vector1, const struct FVector& Vector2, float Tolerance)
{
	static class UFunction* Func = nullptr;
...
void UHDAINavigationHandler::GotoLocation(const struct FVector& InLocation)
{
	static class UFunction* Func = nullptr;
...
void UHDAINavigationHandler::GotoLocationRandomized(const struct FVector& InLocation, float InRandomizationRadius)
{
	static class UFunction* Func = nullptr;
...
bool UHDAIPerceptionComponent::CanBeSeenFrom(const struct FVector& ObserverLocation, struct FVector* OutSeenLocation, int32* NumberOfLoSChecksPerformed, float* OutSightStrength, const class AActor* IgnoreActor) const
{
	static class UFunction* Func = nullptr;
...
void AHDBaseCapturePoint::OnBeginOverlap(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;
...
void UHDButtonBase::SetButtonText(const class FText& InText)
{
	static class UFunction* Func = nullptr;
...
void UHDButtonBase::UpdateButtonText(const class FText& InText)
{
	static class UFunction* Func = nullptr;
...
void AHDPlayerController::ClientLoadTeamData(const TArray<class FString>& FactionAssetPaths)
{
	static class UFunction* Func = nullptr;
...
bool AHDPlayerController::IsTalkingOverChannel(const class UDFCommChannel* TalkChannel)
{
	static class UFunction* Func = nullptr;
...
void AHDPlayerController::ServerPickTeam(const EHDTeam DesiredTeam)
{
	static class UFunction* Func = nullptr;
...
void UHDConfirmationDialog::UpdateDialogText(const class FText& TitleText, const class FText& DescriptionText)
{
	static class UFunction* Func = nullptr;
...
void UHDGameInstance::ShowConfirmationDialog(const class FText& Title, const class FText& Message)
{
	static class UFunction* Func = nullptr;
...
void UHDGameInstance::ShowErrorDialog(const class FText& Title, const class FText& Message)
{
	static class UFunction* Func = nullptr;
...
bool AHDGameState::IsGameUsingPlayerSpawnKitRestrictions(const class AController* Controller) const
{
	static class UFunction* Func = nullptr;
...
bool UHDKit::GetItemEntryDisplayEquipmentSymbol(const struct FHDItemEntry& ItemEntry, class UTexture2D** OutDisplayEquipmentSymbol)
{
	static class UFunction* Func = nullptr;
...
bool UHDKit::GetItemEntryDisplayIcon(const struct FHDItemEntry& ItemEntry, class UTexture2D** OutDisplayIcon)
{
	static class UFunction* Func = nullptr;
...
bool UHDKit::GetItemEntryBySlotNum(const int32 SlotNum, struct FHDItemEntry* OutEntry) const
{
	static class UFunction* Func = nullptr;
...
bool UHDKit::PlayerCanStartWithKit(const class AController* Player, class FText* OutKitDenialReason) const
{
	static class UFunction* Func = nullptr;
...
bool UHDPlatoonCreationRuleBase::SatisfiesRule(const class UHDTeamDefinition* TeamDef) const
{
	static class UFunction* Func = nullptr;
...
bool UHDPlatoonInfo::ShouldCreateForTeam(const class UHDTeamDefinition* TeamDef) const
{
	static class UFunction* Func = nullptr;
...
class AHDSquadState* AHDPlatoonState::AddSquad(const class FText& SquadDisplayName, class AHDPlayerState* SquadLeader, bool bStartLocked)
{
	...
	Parms.SquadDisplayName = std::move(SquadDisplayName);
...
bool AHDPlatoonState::IsSquadPendingRemovalFromPlatoon(const class AHDSquadState* Squad) const
{
	static class UFunction* Func = nullptr;
...
bool AHDPlatoonState::SquadExists(const class AHDSquadState* Squad, bool bIgnorePendingRemoval) const
{
	static class UFunction* Func = nullptr;
...
void AHDSquadState::OnRep_DisplayName(const class FText& PrevDisplayName)
{
	...
	Parms.PrevDisplayName = std::move(PrevDisplayName);
...
bool AHDSquadState::RegisterPlayerSquadMember(const class AHDPlayerController* NewMemberPC)
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::UnregisterPlayerSquadMember(const class AHDPlayerController* MemberPCToRemove)
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::CanRegisterPlayerSquadMember(const class AHDPlayerController* NewMemberPC) const
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::CanRegisterSquadMember(const class AHDPlayerState* NewMemberPS) const
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::IsPendingRemovalFromSquad(const class AHDPlayerState* PS) const
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::IsPlayerPendingRemovalFromSquad(const class AHDPlayerController* PC) const
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::IsPlayerRegisteredSquadMember(const class AHDPlayerController* PC, bool bIgnorePendingRemoval) const
{
	static class UFunction* Func = nullptr;
...
bool AHDSquadState::IsRegisteredSquadMember(const class AHDPlayerState* PS, bool bIgnorePendingRemoval) const
{
	static class UFunction* Func = nullptr;
...
class AHDPlatoonState* AHDTeamState::AddPlatoon(const class UHDPlatoonInfo* PlatoonInfo)
{
	static class UFunction* Func = nullptr;
...
bool AHDTeamState::FindPlatoonByDefinition(const class UHDPlatoonInfo* PlatoonDef, class AHDPlatoonState** OutFoundPlatoon)
{
	static class UFunction* Func = nullptr;
...
bool AHDTeamState::FindPlatoonByName(const class FText& PlatoonDisplayName, class AHDPlatoonState** OutFoundPlatoon)
{
	...
	Parms.PlatoonDisplayName = std::move(PlatoonDisplayName);
...
bool AHDTeamState::IsPlatoonPendingRemovalFromTeam(const class AHDPlatoonState* Platoon) const
{
	static class UFunction* Func = nullptr;
...
bool AHDTeamState::PlatoonExists(const class AHDPlatoonState* Platoon, bool bIgnorePendingRemoval) const
{
	static class UFunction* Func = nullptr;
...
void UHDTextChatInputWidgetBase::SubmitChatMessage(const class FText& ChatMsgText)
{
	...
	Parms.ChatMsgText = std::move(ChatMsgText);
...
class FString UHDUIStatics::GetServerIp(const struct FHDServerInfo& InServerInfo)
{
	static class UFunction* Func = nullptr;
...
class FString UHDUIStatics::GetServerIpPort(const struct FHDServerInfo& InServerInfo)
{
	static class UFunction* Func = nullptr;
...
int32 UHDUIStatics::GetServerPort(const struct FHDServerInfo& InServerInfo)
{
	static class UFunction* Func = nullptr;
