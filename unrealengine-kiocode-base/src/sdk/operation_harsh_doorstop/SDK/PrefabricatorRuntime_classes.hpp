...
public:
	...
	uint8                                         Pad_12D6[0x4];                                     // 0x023C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APrefabActor) == 0x000240, "Wrong size on APrefabActor");
static_assert(offsetof(APrefabActor, PrefabComponent) == 0x000220, "Member 'APrefabActor::PrefabComponent' has a wrong offset!");
static_assert(offsetof(APrefabActor, LastUpdateID) == 0x000228, "Member 'APrefabActor::LastUpdateID' has a wrong offset!");
static_assert(offsetof(APrefabActor, Seed) == 0x000238, "Member 'APrefabActor::Seed' has a wrong offset!");
...
static_assert(sizeof(AReplicablePrefabActor) == 0x000240, "Wrong size on AReplicablePrefabActor");
...
public:
	...
	uint8                                         Pad_12D8[0x8];                                     // 0x0218(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPrefabComponent) == 0x000220, "Wrong size on UPrefabComponent");
static_assert(offsetof(UPrefabComponent, PrefabAssetInterface) == 0x0001F0, "Member 'UPrefabComponent::PrefabAssetInterface' has a wrong offset!");
...
static_assert(sizeof(APrefabDebugActor) == 0x000238, "Wrong size on APrefabDebugActor");
static_assert(offsetof(APrefabDebugActor, Actor) == 0x000220, "Member 'APrefabDebugActor::Actor' has a wrong offset!");
static_assert(offsetof(APrefabDebugActor, ActorData) == 0x000228, "Member 'APrefabDebugActor::ActorData' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_12D9[0x3];                                     // 0x0221(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12DA[0x4];                                     // 0x022C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12DB[0x7];                                     // 0x0241(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12DC[0x18];                                    // 0x0258(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(APrefabRandomizer) == 0x000270, "Wrong size on APrefabRandomizer");
static_assert(offsetof(APrefabRandomizer, bRandomizeOnBeginPlay) == 0x000220, "Member 'APrefabRandomizer::bRandomizeOnBeginPlay' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, SeedOffset) == 0x000224, "Member 'APrefabRandomizer::SeedOffset' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, MaxBuildTimePerFrame) == 0x000228, "Member 'APrefabRandomizer::MaxBuildTimePerFrame' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, OnRandomizationComplete) == 0x000230, "Member 'APrefabRandomizer::OnRandomizationComplete' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, bFastSyncBuild) == 0x000240, "Member 'APrefabRandomizer::bFastSyncBuild' has a wrong offset!");
static_assert(offsetof(APrefabRandomizer, ActorsToRandomize) == 0x000248, "Member 'APrefabRandomizer::ActorsToRandomize' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_12DD[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12DE[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12DF[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12E0[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12E1[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12E2[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_12E6[0x6];                                     // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_12E7[0x4];                                     // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPrefabSeedLinkerComponent) == 0x0001F0, "Wrong size on UPrefabSeedLinkerComponent");
...
static_assert(sizeof(APrefabSeedLinker) == 0x000238, "Wrong size on APrefabSeedLinker");
static_assert(offsetof(APrefabSeedLinker, LinkedActors) == 0x000220, "Member 'APrefabSeedLinker::LinkedActors' has a wrong offset!");
static_assert(offsetof(APrefabSeedLinker, SeedLinkerComponent) == 0x000230, "Member 'APrefabSeedLinker::SeedLinkerComponent' has a wrong offset!");
