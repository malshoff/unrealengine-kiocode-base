...
void ILoadingScreenWidgetInterface::SetLevelLoadData(const struct FLoadScreenLevelData& LevelData)
{
...
void ILoadingScreenWidgetInterface::SetLoadingScreenDescription(const struct FLoadingScreenDescription& Description)
{
	static class UFunction* Func = nullptr;
