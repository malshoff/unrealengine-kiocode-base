...
{
public:
	uint8                                         Pad_1A80[0x50];                                    // 0x1A80(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1AD4[0x4C];                                    // 0x1AD4(0x004C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UIpConnection) == 0x001B20, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001AD0, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
