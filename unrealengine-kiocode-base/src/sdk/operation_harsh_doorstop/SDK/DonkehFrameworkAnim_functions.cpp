...
bool UAnimNotify_PlayFootstepFX::EqualProps(const struct FFootstepFXSettings& Props, const struct FFootstepFXSettings& OtherProps)
{
...
void UAnimNotify_PlayFootstepFX::SetFootstepNotifyProps(const struct FFootstepFXSettings& PropsToUse) const
{
	static class UFunction* Func = nullptr;
