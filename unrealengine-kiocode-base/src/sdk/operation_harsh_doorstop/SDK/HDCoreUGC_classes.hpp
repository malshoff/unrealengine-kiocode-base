...
static_assert(alignof(UHDCoreUGCProjectPolicies) == 0x000008, "Wrong alignment on UHDCoreUGCProjectPolicies");
static_assert(sizeof(UHDCoreUGCProjectPolicies) == 0x000028, "Wrong size on UHDCoreUGCProjectPolicies");
...
static_assert(alignof(UHDCoreUGCPluginStateMachine) == 0x000008, "Wrong alignment on UHDCoreUGCPluginStateMachine");
static_assert(sizeof(UHDCoreUGCPluginStateMachine) == 0x000218, "Wrong size on UHDCoreUGCPluginStateMachine");
static_assert(offsetof(UHDCoreUGCPluginStateMachine, StateProperties) == 0x000048, "Member 'UHDCoreUGCPluginStateMachine::StateProperties' has a wrong offset!");
...
static_assert(alignof(UHDCoreDefaultUGCProjectPolicies) == 0x000008, "Wrong alignment on UHDCoreDefaultUGCProjectPolicies");
static_assert(sizeof(UHDCoreDefaultUGCProjectPolicies) == 0x000030, "Wrong size on UHDCoreDefaultUGCProjectPolicies");
...
static_assert(alignof(UHDCoreUGCData) == 0x000008, "Wrong alignment on UHDCoreUGCData");
static_assert(sizeof(UHDCoreUGCData) == 0x000030, "Wrong size on UHDCoreUGCData");
...
static_assert(alignof(UHDCoreUGCSubsystem) == 0x000008, "Wrong alignment on UHDCoreUGCSubsystem");
static_assert(sizeof(UHDCoreUGCSubsystem) == 0x000160, "Wrong size on UHDCoreUGCSubsystem");
static_assert(offsetof(UHDCoreUGCSubsystem, UGCPluginStateMachines) == 0x000060, "Member 'UHDCoreUGCSubsystem::UGCPluginStateMachines' has a wrong offset!");
static_assert(offsetof(UHDCoreUGCSubsystem, GameSpecificPolicies) == 0x000150, "Member 'UHDCoreUGCSubsystem::GameSpecificPolicies' has a wrong offset!");
...
static_assert(alignof(UHDCoreUGCSubsystemSettings) == 0x000008, "Wrong alignment on UHDCoreUGCSubsystemSettings");
static_assert(sizeof(UHDCoreUGCSubsystemSettings) == 0x000080, "Wrong size on UHDCoreUGCSubsystemSettings");
static_assert(offsetof(UHDCoreUGCSubsystemSettings, UGCManagerClassName) == 0x000038, "Member 'UHDCoreUGCSubsystemSettings::UGCManagerClassName' has a wrong offset!");
static_assert(offsetof(UHDCoreUGCSubsystemSettings, DisabledPlugins) == 0x000050, "Member 'UHDCoreUGCSubsystemSettings::DisabledPlugins' has a wrong offset!");
static_assert(offsetof(UHDCoreUGCSubsystemSettings, AdditionalPluginMetadataKeys) == 0x000060, "Member 'UHDCoreUGCSubsystemSettings::AdditionalPluginMetadataKeys' has a wrong offset!");
