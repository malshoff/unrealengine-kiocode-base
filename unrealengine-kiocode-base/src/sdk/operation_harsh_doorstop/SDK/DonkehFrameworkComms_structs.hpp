...
static_assert(alignof(FDFCommStateSetupParams) == 0x000008, "Wrong alignment on FDFCommStateSetupParams");
static_assert(sizeof(FDFCommStateSetupParams) == 0x000018, "Wrong size on FDFCommStateSetupParams");
static_assert(offsetof(FDFCommStateSetupParams, OwningChannel) == 0x000000, "Member 'FDFCommStateSetupParams::OwningChannel' has a wrong offset!");
static_assert(offsetof(FDFCommStateSetupParams, OwningChannelDefinition) == 0x000008, "Member 'FDFCommStateSetupParams::OwningChannelDefinition' has a wrong offset!");
static_assert(offsetof(FDFCommStateSetupParams, OwningChannelCommsCompOwner) == 0x000010, "Member 'FDFCommStateSetupParams::OwningChannelCommsCompOwner' has a wrong offset!");
...
static_assert(offsetof(FDFGenericChannelMsg, ChatMsgContent) == 0x000000, "Member 'FDFGenericChannelMsg::ChatMsgContent' has a wrong offset!");
static_assert(offsetof(FDFGenericChannelMsg, OptionalMsgData) == 0x000018, "Member 'FDFGenericChannelMsg::OptionalMsgData' has a wrong offset!");
static_assert(offsetof(FDFGenericChannelMsg, SenderPS) == 0x000028, "Member 'FDFGenericChannelMsg::SenderPS' has a wrong offset!");
static_assert(offsetof(FDFGenericChannelMsg, MsgID) == 0x000030, "Member 'FDFGenericChannelMsg::MsgID' has a wrong offset!");
...
static_assert(alignof(FDFChannelMsgRecord) == 0x000008, "Wrong alignment on FDFChannelMsgRecord");
static_assert(sizeof(FDFChannelMsgRecord) == 0x000048, "Wrong size on FDFChannelMsgRecord");
static_assert(offsetof(FDFChannelMsgRecord, Msg) == 0x000000, "Member 'FDFChannelMsgRecord::Msg' has a wrong offset!");
static_assert(offsetof(FDFChannelMsgRecord, MsgFormat) == 0x000038, "Member 'FDFChannelMsgRecord::MsgFormat' has a wrong offset!");
static_assert(offsetof(FDFChannelMsgRecord, MsgChannel) == 0x000040, "Member 'FDFChannelMsgRecord::MsgChannel' has a wrong offset!");
...
static_assert(offsetof(FDFCommChannelMapItemEntry, Key) == 0x00000C, "Member 'FDFCommChannelMapItemEntry::Key' has a wrong offset!");
static_assert(offsetof(FDFCommChannelMapItemEntry, Value) == 0x000018, "Member 'FDFCommChannelMapItemEntry::Value' has a wrong offset!");
...
static_assert(offsetof(FDFCommChannelMap, ChannelEntries) == 0x000108, "Member 'FDFCommChannelMap::ChannelEntries' has a wrong offset!");
static_assert(offsetof(FDFCommChannelMap, ChannelMap) == 0x000118, "Member 'FDFCommChannelMap::ChannelMap' has a wrong offset!");
...
static_assert(alignof(FDFCommsFormatEntry) == 0x000008, "Wrong alignment on FDFCommsFormatEntry");
static_assert(sizeof(FDFCommsFormatEntry) == 0x000020, "Wrong size on FDFCommsFormatEntry");
static_assert(offsetof(FDFCommsFormatEntry, FormatName) == 0x000000, "Member 'FDFCommsFormatEntry::FormatName' has a wrong offset!");
static_assert(offsetof(FDFCommsFormatEntry, FormatClass) == 0x000008, "Member 'FDFCommsFormatEntry::FormatClass' has a wrong offset!");
...
static_assert(alignof(FDFCommChannelEntry) == 0x000008, "Wrong alignment on FDFCommChannelEntry");
static_assert(sizeof(FDFCommChannelEntry) == 0x000018, "Wrong size on FDFCommChannelEntry");
static_assert(offsetof(FDFCommChannelEntry, ChannelDefinition) == 0x000000, "Member 'FDFCommChannelEntry::ChannelDefinition' has a wrong offset!");
...
static_assert(sizeof(FDFPlayerVOIPTalkingState) == 0x000010, "Wrong size on FDFPlayerVOIPTalkingState");
static_assert(offsetof(FDFPlayerVOIPTalkingState, TalkerChannel) == 0x000008, "Member 'FDFPlayerVOIPTalkingState::TalkerChannel' has a wrong offset!");
