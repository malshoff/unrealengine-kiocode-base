...
static_assert(alignof(UDFBaseMenu) == 0x000008, "Wrong alignment on UDFBaseMenu");
static_assert(sizeof(UDFBaseMenu) == 0x000238, "Wrong size on UDFBaseMenu");
...
static_assert(alignof(UDFContextualWidgetBase) == 0x000008, "Wrong alignment on UDFContextualWidgetBase");
static_assert(sizeof(UDFContextualWidgetBase) == 0x000240, "Wrong size on UDFContextualWidgetBase");
static_assert(offsetof(UDFContextualWidgetBase, Prerequisites) == 0x000230, "Member 'UDFContextualWidgetBase::Prerequisites' has a wrong offset!");
...
static_assert(alignof(UDFContextualWidgetPrerequisiteBase) == 0x000008, "Wrong alignment on UDFContextualWidgetPrerequisiteBase");
static_assert(sizeof(UDFContextualWidgetPrerequisiteBase) == 0x000030, "Wrong size on UDFContextualWidgetPrerequisiteBase");
...
static_assert(alignof(UDFGameDialogDescriptor) == 0x000008, "Wrong alignment on UDFGameDialogDescriptor");
static_assert(sizeof(UDFGameDialogDescriptor) == 0x000068, "Wrong size on UDFGameDialogDescriptor");
static_assert(offsetof(UDFGameDialogDescriptor, Header) == 0x000028, "Member 'UDFGameDialogDescriptor::Header' has a wrong offset!");
static_assert(offsetof(UDFGameDialogDescriptor, Body) == 0x000040, "Member 'UDFGameDialogDescriptor::Body' has a wrong offset!");
static_assert(offsetof(UDFGameDialogDescriptor, ButtonActions) == 0x000058, "Member 'UDFGameDialogDescriptor::ButtonActions' has a wrong offset!");
...
static_assert(alignof(UDFGameDialog) == 0x000008, "Wrong alignment on UDFGameDialog");
static_assert(sizeof(UDFGameDialog) == 0x000238, "Wrong size on UDFGameDialog");
...
static_assert(alignof(UDFMenuManager) == 0x000008, "Wrong alignment on UDFMenuManager");
static_assert(sizeof(UDFMenuManager) == 0x000058, "Wrong size on UDFMenuManager");
static_assert(offsetof(UDFMenuManager, MenuStack) == 0x000030, "Member 'UDFMenuManager::MenuStack' has a wrong offset!");
static_assert(offsetof(UDFMenuManager, MenuManagerClassName) == 0x000040, "Member 'UDFMenuManager::MenuManagerClassName' has a wrong offset!");
...
{
public:
	static class UDFBaseMenu* CreateAndActivate(class UObject* WorldContextObject, TSubclassOf<class UDFBaseMenu> MenuWidgetType, class APlayerController* OwningPlayer, const EMenuActivationMode ActivationMode, const bool bShowMouseCursor, const bool bUIOnlyInput);
...
static_assert(alignof(UDFMenuManagerBlueprintFunctions) == 0x000008, "Wrong alignment on UDFMenuManagerBlueprintFunctions");
static_assert(sizeof(UDFMenuManagerBlueprintFunctions) == 0x000028, "Wrong size on UDFMenuManagerBlueprintFunctions");
...
static_assert(alignof(UDFMinimap) == 0x000008, "Wrong alignment on UDFMinimap");
static_assert(sizeof(UDFMinimap) == 0x000298, "Wrong size on UDFMinimap");
static_assert(offsetof(UDFMinimap, MapPOIs) == 0x000230, "Member 'UDFMinimap::MapPOIs' has a wrong offset!");
static_assert(offsetof(UDFMinimap, CurrentMapPos) == 0x000258, "Member 'UDFMinimap::CurrentMapPos' has a wrong offset!");
static_assert(offsetof(UDFMinimap, CurrentZoom) == 0x000260, "Member 'UDFMinimap::CurrentZoom' has a wrong offset!");
static_assert(offsetof(UDFMinimap, MaxZoom) == 0x000264, "Member 'UDFMinimap::MaxZoom' has a wrong offset!");
static_assert(offsetof(UDFMinimap, MapLength) == 0x000268, "Member 'UDFMinimap::MapLength' has a wrong offset!");
static_assert(offsetof(UDFMinimap, MapOffset) == 0x00026C, "Member 'UDFMinimap::MapOffset' has a wrong offset!");
static_assert(offsetof(UDFMinimap, POIDataTable) == 0x000278, "Member 'UDFMinimap::POIDataTable' has a wrong offset!");
static_assert(offsetof(UDFMinimap, OuterCanvas) == 0x000280, "Member 'UDFMinimap::OuterCanvas' has a wrong offset!");
static_assert(offsetof(UDFMinimap, MapCanvas) == 0x000288, "Member 'UDFMinimap::MapCanvas' has a wrong offset!");
static_assert(offsetof(UDFMinimap, MapImg) == 0x000290, "Member 'UDFMinimap::MapImg' has a wrong offset!");
...
static_assert(alignof(UDFPOIComponent) == 0x000008, "Wrong alignment on UDFPOIComponent");
static_assert(sizeof(UDFPOIComponent) == 0x0000C8, "Wrong size on UDFPOIComponent");
...
static_assert(alignof(UDFPOIWidget) == 0x000008, "Wrong alignment on UDFPOIWidget");
static_assert(sizeof(UDFPOIWidget) == 0x0003A0, "Wrong size on UDFPOIWidget");
static_assert(offsetof(UDFPOIWidget, POIActor) == 0x000240, "Member 'UDFPOIWidget::POIActor' has a wrong offset!");
static_assert(offsetof(UDFPOIWidget, POIActorData) == 0x000248, "Member 'UDFPOIWidget::POIActorData' has a wrong offset!");
static_assert(offsetof(UDFPOIWidget, OnSelectionStateChanged) == 0x000380, "Member 'UDFPOIWidget::OnSelectionStateChanged' has a wrong offset!");
static_assert(offsetof(UDFPOIWidget, IconSlot) == 0x000398, "Member 'UDFPOIWidget::IconSlot' has a wrong offset!");
...
static_assert(alignof(UDFUIMessagingSubsystem) == 0x000008, "Wrong alignment on UDFUIMessagingSubsystem");
static_assert(sizeof(UDFUIMessagingSubsystem) == 0x000098, "Wrong size on UDFUIMessagingSubsystem");
static_assert(offsetof(UDFUIMessagingSubsystem, TopmostDialog) == 0x000030, "Member 'UDFUIMessagingSubsystem::TopmostDialog' has a wrong offset!");
static_assert(offsetof(UDFUIMessagingSubsystem, ConfirmationDialogClassPtr) == 0x000038, "Member 'UDFUIMessagingSubsystem::ConfirmationDialogClassPtr' has a wrong offset!");
static_assert(offsetof(UDFUIMessagingSubsystem, ErrorDialogClassPtr) == 0x000040, "Member 'UDFUIMessagingSubsystem::ErrorDialogClassPtr' has a wrong offset!");
static_assert(offsetof(UDFUIMessagingSubsystem, ConfirmationDialogClass) == 0x000048, "Member 'UDFUIMessagingSubsystem::ConfirmationDialogClass' has a wrong offset!");
static_assert(offsetof(UDFUIMessagingSubsystem, ErrorDialogClass) == 0x000070, "Member 'UDFUIMessagingSubsystem::ErrorDialogClass' has a wrong offset!");
...
static_assert(alignof(IPOIWidgetSlotInterface) == 0x000008, "Wrong alignment on IPOIWidgetSlotInterface");
static_assert(sizeof(IPOIWidgetSlotInterface) == 0x000028, "Wrong size on IPOIWidgetSlotInterface");
