...
void UDFContextualWidgetBase::PrerequisiteNotMet(const class UDFContextualWidgetPrerequisiteBase* FailedPrereq)
{
	static class UFunction* Func = nullptr;
...
void UDFMenuManager::ActivateMenu(class UDFBaseMenu* MenuToAdd, EMenuActivationMode ActivationMode, const bool bShowMouseCursor, const bool bUIOnlyInput)
{
	static class UFunction* Func = nullptr;
...
class UDFBaseMenu* UDFMenuManagerBlueprintFunctions::CreateAndActivate(class UObject* WorldContextObject, TSubclassOf<class UDFBaseMenu> MenuWidgetType, class APlayerController* OwningPlayer, const EMenuActivationMode ActivationMode, const bool bShowMouseCursor, const bool bUIOnlyInput)
{
	static class UFunction* Func = nullptr;
...
bool UDFMinimap::FindPOIByActor(const class AActor* POIActor, class UDFPOIWidget** OutFoundPOI)
{
	static class UFunction* Func = nullptr;
...
bool UDFMinimap::RemovePOIByActor(const class AActor* POIActorToRemove)
{
	static class UFunction* Func = nullptr;
...
bool UDFMinimap::RemovePOIByActorClass(const TSubclassOf<class AActor>& POIActorClass)
{
	static class UFunction* Func = nullptr;
...
void UDFPOIWidget::InitPOI(class UDFMinimap* OwningMapWidget, class AActor* ActorToTrack, struct FMinimapPOITableRow* ActorPOIData)
{
	...
	if (ActorPOIData != nullptr)
		*ActorPOIData = std::move(Parms.ActorPOIData);
}
...
void IPOIWidgetSlotInterface::SetIconBrush(const struct FSlateBrush& NewIconBrush)
{
	static class UFunction* Func = nullptr;
