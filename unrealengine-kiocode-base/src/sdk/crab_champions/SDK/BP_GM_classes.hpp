...
static_assert(sizeof(ABP_GM_C) == 0x000398, "Wrong size on ABP_GM_C");
static_assert(offsetof(ABP_GM_C, DefaultSceneRoot) == 0x000390, "Member 'ABP_GM_C::DefaultSceneRoot' has a wrong offset!");
