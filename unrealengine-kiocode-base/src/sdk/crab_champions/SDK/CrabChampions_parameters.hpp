...
static_assert(sizeof(CrabC_OnRep_DebuffState) == 0x000014, "Wrong size on CrabC_OnRep_DebuffState");
...
public:
	...
	uint8                                         Pad_1434[0x3];                                     // 0x0045(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1471[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(CrabDestructible_OnComponentHit) == 0x000008, "Wrong alignment on CrabDestructible_OnComponentHit");
static_assert(sizeof(CrabDestructible_OnComponentHit) == 0x0000B0, "Wrong size on CrabDestructible_OnComponentHit");
static_assert(offsetof(CrabDestructible_OnComponentHit, HitComponent) == 0x000000, "Member 'CrabDestructible_OnComponentHit::HitComponent' has a wrong offset!");
static_assert(offsetof(CrabDestructible_OnComponentHit, OtherActor) == 0x000008, "Member 'CrabDestructible_OnComponentHit::OtherActor' has a wrong offset!");
static_assert(offsetof(CrabDestructible_OnComponentHit, OtherComp) == 0x000010, "Member 'CrabDestructible_OnComponentHit::OtherComp' has a wrong offset!");
static_assert(offsetof(CrabDestructible_OnComponentHit, NormalImpulse) == 0x000018, "Member 'CrabDestructible_OnComponentHit::NormalImpulse' has a wrong offset!");
static_assert(offsetof(CrabDestructible_OnComponentHit, Hit) == 0x000024, "Member 'CrabDestructible_OnComponentHit::Hit' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1495[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_149E[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FCrabAutoSave                          AutoSave;                                          // 0x0000(0x0148)(ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(CrabPC_ServerRestoreAutoSave) == 0x000008, "Wrong alignment on CrabPC_ServerRestoreAutoSave");
static_assert(sizeof(CrabPC_ServerRestoreAutoSave) == 0x000148, "Wrong size on CrabPC_ServerRestoreAutoSave");
...
public:
	...
	struct FVector                                NormalImpulse;                                     // 0x0018(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FHitResult                             Hit;                                               // 0x0024(0x0088)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_14A5[0x4];                                     // 0x00AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(CrabPhysicsActor_OnComponentHit) == 0x000008, "Wrong alignment on CrabPhysicsActor_OnComponentHit");
static_assert(sizeof(CrabPhysicsActor_OnComponentHit) == 0x0000B0, "Wrong size on CrabPhysicsActor_OnComponentHit");
static_assert(offsetof(CrabPhysicsActor_OnComponentHit, HitComponent) == 0x000000, "Member 'CrabPhysicsActor_OnComponentHit::HitComponent' has a wrong offset!");
static_assert(offsetof(CrabPhysicsActor_OnComponentHit, OtherActor) == 0x000008, "Member 'CrabPhysicsActor_OnComponentHit::OtherActor' has a wrong offset!");
static_assert(offsetof(CrabPhysicsActor_OnComponentHit, OtherComp) == 0x000010, "Member 'CrabPhysicsActor_OnComponentHit::OtherComp' has a wrong offset!");
static_assert(offsetof(CrabPhysicsActor_OnComponentHit, NormalImpulse) == 0x000018, "Member 'CrabPhysicsActor_OnComponentHit::NormalImpulse' has a wrong offset!");
static_assert(offsetof(CrabPhysicsActor_OnComponentHit, Hit) == 0x000024, "Member 'CrabPhysicsActor_OnComponentHit::Hit' has a wrong offset!");
...
static_assert(alignof(CrabPlayerC_ServerDealDamage) == 0x000008, "Wrong alignment on CrabPlayerC_ServerDealDamage");
static_assert(sizeof(CrabPlayerC_ServerDealDamage) == 0x000010, "Wrong size on CrabPlayerC_ServerDealDamage");
static_assert(offsetof(CrabPlayerC_ServerDealDamage, DamageInfoArray) == 0x000000, "Member 'CrabPlayerC_ServerDealDamage::DamageInfoArray' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_14E0[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(CrabPS_ServerRemoveAbilityMod) == 0x000001, "Wrong alignment on CrabPS_ServerRemoveAbilityMod");
static_assert(sizeof(CrabPS_ServerRemoveAbilityMod) == 0x000001, "Wrong size on CrabPS_ServerRemoveAbilityMod");
static_assert(offsetof(CrabPS_ServerRemoveAbilityMod, AbilityModType) == 0x000000, "Member 'CrabPS_ServerRemoveAbilityMod::AbilityModType' has a wrong offset!");
...
static_assert(alignof(CrabPS_ServerRemoveMeleeMod) == 0x000001, "Wrong alignment on CrabPS_ServerRemoveMeleeMod");
static_assert(sizeof(CrabPS_ServerRemoveMeleeMod) == 0x000001, "Wrong size on CrabPS_ServerRemoveMeleeMod");
static_assert(offsetof(CrabPS_ServerRemoveMeleeMod, MeleeModType) == 0x000000, "Member 'CrabPS_ServerRemoveMeleeMod::MeleeModType' has a wrong offset!");
