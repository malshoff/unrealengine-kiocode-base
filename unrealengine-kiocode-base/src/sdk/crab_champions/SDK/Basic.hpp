...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04295EB0;
	constexpr int32 AppendString      = 0x00EBF760;
	constexpr int32 GNames            = 0x04259BC0;
	constexpr int32 GWorld            = 0x043D8FB8;
	constexpr int32 ProcessEvent      = 0x010B7500;
