...
static_assert(sizeof(ABP_Strike_Spike_C) == 0x000280, "Wrong size on ABP_Strike_Spike_C");
static_assert(offsetof(ABP_Strike_Spike_C, DefaultSceneRoot) == 0x000278, "Member 'ABP_Strike_Spike_C::DefaultSceneRoot' has a wrong offset!");
