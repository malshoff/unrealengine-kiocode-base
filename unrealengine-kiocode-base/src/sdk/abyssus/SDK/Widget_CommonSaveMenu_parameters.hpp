...
public:
	...
	class UWidget_CommonInputDialog_C*            CallFunc_PushWidget_OutWidget_1;                   // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWidget_SaveSlot_C*                     K2Node_DynamicCast_AsWidget_Save_Slot;             // 0x0050(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class URSaveGame*                             K2Node_DynamicCast_AsRSave_Game;                   // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_CustomEvent_Input;                          // 0x0080(0x0010)()
	...
	ERSavedGameResult                             CallFunc_SaveGameToSlot_ReturnValue;               // 0x00A1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class URSaveGame*                             CallFunc_CreateSaveGame_ReturnValue;               // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_ValidateProfileNameInput_Valid;           // 0x00B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget_CommonInfoDialog_C*             CallFunc_PushWidget_OutWidget_2;                   // 0x00D8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class FText Input)>            K2Node_CreateDelegate_OutputDelegate_2;            // 0x00E0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget_CommonInfoDialog_C*             CallFunc_PushWidget_OutWidget_3;                   // 0x00F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu) == 0x000100, "Wrong size on Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu");
...
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_PushWidget_OutWidget) == 0x000010, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_PushWidget_OutWidget' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_CreateDelegate_OutputDelegate) == 0x000018, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_GetOwningPlayer_ReturnValue_1) == 0x000028, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_GetOwningPlayer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_ComponentBoundEvent_Item) == 0x000030, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_ComponentBoundEvent_Item' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_ComponentBoundEvent_Widget) == 0x000038, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_ComponentBoundEvent_Widget' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_PushWidget_OutWidget_1) == 0x000040, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_PushWidget_OutWidget_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_IsValid_ReturnValue) == 0x000048, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_DynamicCast_AsWidget_Save_Slot) == 0x000050, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_DynamicCast_AsWidget_Save_Slot' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_IsValid_ReturnValue_1) == 0x000059, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_DynamicCast_AsRSave_Game) == 0x000060, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_DynamicCast_AsRSave_Game' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_CreateDelegate_OutputDelegate_1) == 0x00006C, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_CustomEvent_Input) == 0x000080, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_CustomEvent_Input' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_Conv_TextToString_ReturnValue) == 0x000090, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_TextIsEmpty_ReturnValue) == 0x0000A0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_SaveGameToSlot_ReturnValue) == 0x0000A1, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_SaveGameToSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0000A2, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_CreateSaveGame_ReturnValue) == 0x0000A8, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_CreateSaveGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_DoesSaveGameExist_ReturnValue) == 0x0000B0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_DoesSaveGameExist_ReturnValue' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_ValidateProfileNameInput_Valid) == 0x0000B1, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_ValidateProfileNameInput_Valid' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_ComponentBoundEvent_Button_1) == 0x0000B8, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_ComponentBoundEvent_Button_1' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_ComponentBoundEvent_Button) == 0x0000C0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_IsValid_ReturnValue_2) == 0x0000C8, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_GetOwningPlayer_ReturnValue_2) == 0x0000D0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_GetOwningPlayer_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_PushWidget_OutWidget_2) == 0x0000D8, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_PushWidget_OutWidget_2' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, K2Node_CreateDelegate_OutputDelegate_2) == 0x0000E0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_GetOwningPlayer_ReturnValue_3) == 0x0000F0, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_GetOwningPlayer_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu, CallFunc_PushWidget_OutWidget_3) == 0x0000F8, "Member 'Widget_CommonSaveMenu_C_ExecuteUbergraph_Widget_CommonSaveMenu::CallFunc_PushWidget_OutWidget_3' has a wrong offset!");
